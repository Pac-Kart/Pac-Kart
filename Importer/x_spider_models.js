...
function im_models(offset, index) {
    ...
    function get_sub_section(offset, XFA) {
        ...
        for (let i = 0; i < u32(offset + 8); i++) {
            get_sub_section_12(u32(offset + 12) + g.m + i, XFA[0].section_12)
        }
...
function im_models_(o, i, x) {
    ...
    // for (let ii = 0; ii < u32(o + 02); ii++) {
    //     im_models_04(u32(o + 04) + (ii * 8) + g.m, ii, x[i].section_04);
    // }
    // x[i].unordered_model_name_08 = in_ml(u32(o + 08), g.model_name_array, im_model_name, g.unordered_ref.model_name);
...
function im_models_04(o, i, x) {
    ...
    u32(o + 04) ? im_models_04_04(u32(o + 04) + g.m, x[i].section_04) : 0;
...
function im_models_04_04(o, x) {
    ...
    u32(o + 00) ? im_models_04_04_00(u32(o + 00) + g.m, x[0].section_00) : 0;
...
//         im_models_04_04(u32(o + 04) + (ii * 4) + g.m, ii, x[i].section_04);
//     }
...
//     u32(o + 00) ? im_models_04_04_00(u32(o + 00) + g.m, x[i].section_00) : 0;
