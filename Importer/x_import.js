// attempting to make a generic version
// im = import
// x = .x* file array
// o = offset
// work on this later

async function im_x(selected_game, selected_console, file_name) {
    x = []
    id_list = []
    ...
    // download_file.download = gfile.name
...
function im_datapack(o, x) {
    ...
    let offset_after_datapack = o + get_datapack_end()
...
function im_basic(o, x) {
    ...
    in_basic_04(u32(o + 4) + o, x[0].basic_04)
