function im_link(o, i, x) {
    ...
    u32(o + 00) ? im_link_00(u32(o + 00) + g.m, x[i].section_00) : 0;

    for (let ii = 0; ii < u32(o + 04); ii++) {
        im_link_intro(u32(o + 08) + (ii * 16) + g.m, ii, x[i].section_08);
    }
...
function im_xdx_link(o, x) {
    ...
    for (let i = 0; i < u32(o + 04); i++) {
        im_xdx_link_08(u32(o + 08) + (i * 12) + g.m, i, x[0].section_08);
    }
...
function im_link_intro(o, i, x) {
    let str = [null]
    if (u8(o + 00) ===0) {
        str = [im_string(u32(o + 04), 0, false)]
    }
    x.push({
        id: gen_id(),
        u8_00: u8(o + 00),
    ...
    u32(o + 08) ? im_link_intro_08(u32(o + 08) + g.m, x[i].section_08) : 0;
...
function im_xdx_link_24(o, i, x) {
    ...
    u32(o + 00) ? im_xdx_link_24_00(u32(o + 00) + g.m, x[i].section_00) : 0;
...
function im_link_32_00_04_20(o, i, x) {
    ...
    for (let ii = 0; ii < u32(o + 00); ii++) {
        im_link_32_00_04_20_04(u32(o + 04) + (ii * 8) + g.m, ii, x[i].section_04);
    }
