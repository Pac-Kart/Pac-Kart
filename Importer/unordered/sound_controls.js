...
for (let ii = 0; ii < u32(o + 12); ii++) {
    ...
    // u32(o + 16) ? im_sound_controls_16(u32(o + 16) + g.m, x[i].section_16) : 0;
    return x[i].id
    // 32 bytes;
...
function im_sound_controls_16(o, i, x) {
    ...
    for (let ii = 0; ii < u32(o + 00); ii++) {
        im_sound_controls_16_04(u32(o + 04) + (ii * 4) + g.m, ii, x[i].section_04);
    }
...
function im_sound_controls_16_04(o, i, x) {
    ...
    x[i].unordered_sound_section_00 = in_ml(u32(o + 00), g.sound_section_array, im_sound_section, g.unordered_ref.sound_section);
