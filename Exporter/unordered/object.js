...
function ex_object_32t15(o, x) {
    ...
    if (x.section_04.length) {
        ...
        g.oa.push(o + 04)
        let temp_offset = e
        e += divisible(x.section_04.length * 28, 16)
        for (let i = 0; i < x.section_04.length; i++) {
            e = ex_object_32t15_04(temp_offset + (i * 28), e, x.section_04[i])
        }
        ;
    }
    ;e = ex_ml(x.unordered_unknown_00_08, g.unknown_00_array, ex_unknown_00, g.unordered_ref.unknown_00, o + 08, e, 'down');
...
function ex_object_32t15_04_04(o, e, x) {
    ...
    e = ex_ml(x.unordered_um_00, g.um_array, ex_um, g.unordered_ref.um, o + 00, e, 'down');
    e = ex_ml(x.unordered_um_04, g.um_array, ex_um, g.unordered_ref.um, o + 04, e, 'down');
...
function ex_object_32t18(o, x) {
    ...
    e = ex_s_offset(o + 00, e, ex_object_32t18_00, x.section_00, 'down');
