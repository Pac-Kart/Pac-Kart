...
`
    ...
    for (let i = 0; i < starting_points_array.length; i++) {
        html += `<tr>
        <td class='no_border'> <input style='width:50px;' data-type='u8' data-offset='${starting_points_array[i].offset + 121}'  type='text' value='${u8(starting_points_array[i].offset + 121, g.endian)}'></td>
        <td class='no_border'> <input style='width:50px;' data-type='float' data-offset='${starting_points_array[i].offset + 32}'  type='text' value='${f32(starting_points_array[i].offset + 32, g.endian).toFixed(2)}'></td>
        <td class='no_border'> <input style='width:50px;' data-type='float' data-offset='${starting_points_array[i].offset + 36}'  type='text' value='${f32(starting_points_array[i].offset + 36, g.endian).toFixed(2)}'></td>
        <td class='no_border'> <input style='width:50px;' data-type='float' data-offset='${starting_points_array[i].offset + 40}'  type='text' value='${f32(starting_points_array[i].offset + 40, g.endian).toFixed(2)}'></td>
        <td class='no_border'> <input style='width:50px;' data-type='float' data-offset='${starting_points_array[i].offset + 48}'  type='text' value='${f32(starting_points_array[i].offset + 48, g.endian).toFixed(2)}'></td>
        <td class='no_border'> <input style='width:50px;' data-type='float' data-offset='${starting_points_array[i].offset + 52}'  type='text' value='${f32(starting_points_array[i].offset + 52, g.endian).toFixed(2)}'></td>
        <td class='no_border'> <input style='width:50px;' data-type='float' data-offset='${starting_points_array[i].offset + 56}'  type='text' value='${f32(starting_points_array[i].offset + 56, g.endian).toFixed(2)}'></td>
        <td class='no_border'> <input style='width:50px;' data-type='float' data-offset='${starting_points_array[i].offset + 76}'  type='text' value='${f32(starting_points_array[i].offset + 76, g.endian).toFixed(2)}'></td>
        <td class='no_border'> <input style='width:50px;' data-type='float' data-offset='${starting_points_array[i].offset + 80}'  type='text' value='${f32(starting_points_array[i].offset + 80, g.endian)}'></td>
        </tr>`
    }
...
`
    ...
    let cameraOffset = {
        x: -f32(starting_points_array[0].offset + 32, g.endian) / 2,
        y: -f32(starting_points_array[0].offset + 40, g.endian) / 2
    }
    ...
    function onPointerMove(e) {
        ...
        if (is_dragging_element === true) {
            ...
            new DataView(buffer).setFloat32(starting_points_array[selected_index].offset + 32, temp_x - startX - 5, g.endian)
            new DataView(buffer).setFloat32(starting_points_array[selected_index].offset + 40, temp_y - startY - 5, g.endian)
        ...
        if (isDragging) {
            ...
            if (selected_index !== false) {
                ...
                if (is_dragging_element === true) {
                    new DataView(buffer).setFloat32(starting_points_array[selected_index].offset + 32, startX - 5 - netPanningX, g.endian)
                    new DataView(buffer).setFloat32(starting_points_array[selected_index].offset + 40, startY - 5 - netPanningY, g.endian)
...
function draw_canvas_start(netPanningX, netPanningY, cameraZoom, element_selected, temp_x, temp_y) {
    ...
    for (let i = 0; i < starting_points_array.length; i++) {
        let x = f32(starting_points_array[i].offset + 32, g.endian) + netPanningX
        let z = f32(starting_points_array[i].offset + 40, g.endian) + netPanningY
...
function object_clicked_start(temp_x, temp_y, startX, startY, cameraZoom, temp_cam_x, temp_cam_y) {
    ...
    for (let i = 0; i < starting_points_array.length; i++) {
        ...
        let left_position = (f32(starting_points_array[i].offset + 32, g.endian)) + startX
        let right_position = (f32(starting_points_array[i].offset + 32, g.endian)) + startX + 10
        let top_position = (f32(starting_points_array[i].offset + 40, g.endian)) + startY
        let bottom_position = (f32(starting_points_array[i].offset + 40, g.endian)) + startY + 10
...
function append_to_file_editor_side_panel_start(offset) {
    let html = `       
                    <a>Position: </a><br>
                    <input class='text_input' data-type="u8" data-offset=${offset + 121} value='${u8(offset + 121, g.endian)}'><br>
                    ...
                    <a>Z Position: </a><br>
                    <input class='text_input' data-type="float" data-offset=${offset + 40} value='${f32(offset + 40, g.endian).toFixed(2)}'><br>
                    
                    <a>X Rotation: </a><br>
                    <input class='text_input' data-type="float" data-offset=${offset + 48} value='${f32(offset + 48, g.endian).toFixed(2)}'><br>
                    
                    <a>Y Rotation: </a><br>
                    <input class='text_input' data-type="float" data-offset=${offset + 52} value='${f32(offset + 52, g.endian).toFixed(2)}'><br>
                    
                    <a>Z Rotation: </a><br>
                    <input class='text_input' data-type="float" data-offset=${offset + 56} value='${f32(offset + 56, g.endian).toFixed(2)}'><br>
                   
                    <a>?1: </a><br>
                    <input class='text_input' data-type="float" data-offset=${offset + 76} value='${f32(offset + 76, g.endian).toFixed(2)}'><br>

                    <a>?2: </a><br>
                    <input class='text_input' data-type="float" data-offset=${offset + 80} value='${f32(offset + 80, g.endian).toFixed(2)}'><br>
