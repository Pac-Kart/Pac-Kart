function load_logic(offset, offset_mid_, file_type) {
    ...
    if (file_type === 'link') {
        ...
        for (let i = 0; i < u32(offset + 4, is_little_endian); i++) {
            html += get_link_2(u32(offset + 8, is_little_endian) + offset_mid + (i * 16), i)
        }
        ...
        for (let i = 0; i < u32(offset + 28, is_little_endian); i++) {
            html += get_link_5(u32(offset + 32, is_little_endian) + offset_mid + (i * 8), i)
        }
        ...
        if (u32(offset + 60, is_little_endian) != 0) {
            html += get_link_9(u32(offset + 60, is_little_endian) + offset_mid)
        }

        for (let i = 0; i < u32(offset + 64, is_little_endian); i++) {
            html += get_link_10(u32(offset + 68, is_little_endian) + offset_mid + (i * 4), i)
        }
...
function get_link_9(offset) {
    ...
    for (let i = 0; i < u32(offset + 24, is_little_endian); i++) {
        html += get_link_9_1(u32(offset + 28, is_little_endian) + offset_mid + (i * 32))
    }
    for (let i = 0; i < u32(offset + 32, is_little_endian); i++) {
        html += get_link_9_2(u32(offset + 36, is_little_endian) + offset_mid + (i * 12))
    }

    return html
}

function get_link_9_2(offset) {
    let html = ''
...
function get_link_5(offset, i) {
    html = ''

    html += `<br>5---${i}> ${u32(offset, is_little_endian)} |  ${u32(offset + 4, is_little_endian)}`

    html += get_link_5_1(u32(offset, is_little_endian) + offset_mid, i)
    return html

}
function get_link_5_1(offset, i) {
    html = ''
    ...
    for (let ii = 0; ii < u32(offset, is_little_endian); ii++) {
        html += get_link_5_1_1(u32(offset + 4, is_little_endian) + offset_mid + (ii * 32), i, ii)
    }
...
function get_link_5_1_1(offset, i, ii) {
    let html = ''
    ...
    for (iii = 0; iii < u32(offset, is_little_endian); iii++) {
        html += get_link_5_1_1_1(u32(offset + 4, is_little_endian) + offset_mid + (iii * 16), i, ii, iii)
    }
    if (u32(offset + 8, is_little_endian) != 0) {
        html += get_link_5_1_1_2(u32(offset + 8, is_little_endian) + offset_mid, i, ii)
    }

    if (u32(offset + 12, is_little_endian) != 0) {
        html += get_link_5_1_1_3(u32(offset + 12, is_little_endian) + offset_mid, i, ii)
    }

    for (let iii = 0; iii < u32(offset + 16, is_little_endian); iii++) {
        html += get_link_5_1_1_4(u32(offset + 20, is_little_endian) + offset_mid + (iii * 12), i, ii, iii)
    }
    for (let iii = 0; iii < u32(offset + 24, is_little_endian); iii++) {
        html += get_link_5_1_1_5(u32(offset + 28, is_little_endian) + offset_mid + (iii * 12), i, ii, iii)
    }
...
function get_link_5_1_1_5(offset, i, ii, iii) {
    let html = ''
    ...
    for (let iiii = 0; iiii < u32(offset, is_little_endian); iiii++) {
        html += get_link_5_1_1_5_1(u32(offset + 4, is_little_endian) + offset_mid + (iiii * 8), i, ii, iii, iiii)
    }

    return html

}
function get_link_5_1_1_5_1(offset, i, ii, iii, iiii) {
    let html = ''
    ...
    html += get_link_5_1_1_5_1_1(u32(offset + 4, is_little_endian) + offset_mid, i, ii, iii, iiii)

    return html

}
function get_link_5_1_1_5_1_1(offset, i, ii, iii, iiii) {
    let html = ''
...
function get_link_5_1_1_4(offset, i, ii, iii) {
    let html = ''
    ...
    for (let iiii = 0; iiii < u32(offset, is_little_endian); iiii++) {
        html += get_link_5_1_1_4_1(u32(offset + 4, is_little_endian) + offset_mid + (iiii * 8), i, ii, iii, iiii)
    }

    return html

}
function get_link_5_1_1_4_1(offset, i, ii, iii, iiii) {
    let html = ''
    ...
    html += get_link_5_1_1_4_1_1(u32(offset + 4, is_little_endian) + offset_mid, i, ii, iii, iiii)

    return html

}
function get_link_5_1_1_4_1_1(offset, i, ii, iii, iiii) {
    let html = ''
...
function get_link_5_1_1_3(offset, i, ii) {
    let html = ''
...
function get_link_5_1_1_2(offset, i, ii) {
    let html = ''
...
function get_link_5_1_1_1(offset, i, ii, iii) {
    html = ''
    ...
    html += get_link_5_1_1_1_1(u32(offset + 4, is_little_endian) + offset_mid, i, ii, iii)

    return html

}
function get_link_5_1_1_1_1(offset, i, ii, iii) {
    html = ''
...
function load_world_low_header(offset) {
    let html = ''
    html += `<br>  ${u32(offset, is_little_endian)} | ${u32(offset + 4, is_little_endian)} | ${u32(offset + 8, is_little_endian)} |  ${u32(offset + 12, is_little_endian)} |<br>
        ...
        ${u32(offset + 64, is_little_endian)} |  ${u32(offset + 68, is_little_endian)} |  ${u32(offset + 72, is_little_endian)} |  ${u32(offset + 76, is_little_endian)} |<br>
        ${u32(offset + 80, is_little_endian)} |  ${u32(offset + 84, is_little_endian)} |  ${u32(offset + 88, is_little_endian)} |  ${u32(offset + 92, is_little_endian)}  |<br>
        ${u32(offset + 96, is_little_endian)} |  ${u32(offset + 100, is_little_endian)} |  ${u32(offset + 104, is_little_endian)} |  ${u32(offset + 108, is_little_endian)} | <br>
        ${u32(offset + 112, is_little_endian)} | ${u32(offset + 116, is_little_endian)}  | ${u32(offset + 120, is_little_endian)} |  ${u32(offset + 124, is_little_endian)} |<br>
        ${u32(offset + 128, is_little_endian)} |  ${u32(offset + 132, is_little_endian)}  |  ${u32(offset + 136, is_little_endian)}  |  ${u32(offset + 140, is_little_endian)}<br>
        |  ${u32(offset + 144, is_little_endian)}  |  ${u32(offset + 148, is_little_endian)}  |  ${u32(offset + 152, is_little_endian)}  |  ${u32(offset + 156, is_little_endian)}<br>
        |  ${u32(offset + 160, is_little_endian)}  |  ${u32(offset + 164, is_little_endian)}  |  ${u32(offset + 168, is_little_endian)}  |  ${u32(offset + 172, is_little_endian)}  | <br>
        ${u32(offset + 176, is_little_endian)}  |  ${u32(offset + 180, is_little_endian)}  |  ${u32(offset + 184, is_little_endian)}  |  ${u32(offset + 188, is_little_endian)}  |<br>
        ${u32(offset + 192, is_little_endian)}  |  ${u32(offset + 196, is_little_endian)}  |  ${u32(offset + 200, is_little_endian)}  |  ${u32(offset + 204, is_little_endian)}`

    html += get_world_low_header_1(u32(offset + 192, is_little_endian) + offset_mid)
    html += get_world_low_header_2(u32(offset + 196, is_little_endian) + offset_mid)

    document.getElementById("file_editor").innerHTML = html

}

function get_world_low_header_1(offset) {
    let html = ''
    html += `<br>---1>  ${u32(offset, is_little_endian)} | ${u32(offset + 4, is_little_endian)} | ${u32(offset + 8, is_little_endian)} |  ${u32(offset + 12, is_little_endian)} |  ${u32(offset + 16, is_little_endian)} |  [ ${u8(offset + 20, is_little_endian)}, ${u8(offset + 21, is_little_endian)}, ${u8(offset + 22, is_little_endian)}, ${u8(offset + 23, is_little_endian)} ] |  ${u32(offset + 24, is_little_endian)} |  ${u32(offset + 28, is_little_endian)} | ${u32(offset + 32, is_little_endian)} | ${u32(offset + 36, is_little_endian)}  |  ${u32(offset + 40, is_little_endian)} |  ${u32(offset + 44, is_little_endian)} |            `

    return html
}
function get_world_low_header_2(offset) {
    let html = ''
    html += `<br>---2>  [ ${u8(offset, is_little_endian)}, ${u8(offset + 1, is_little_endian)}, ${u8(offset + 2, is_little_endian)}, ${u8(offset + 3, is_little_endian)} ] | ${u32(offset + 4, is_little_endian)} | ${u32(offset + 8, is_little_endian)} |  ${u32(offset + 12, is_little_endian)} |  ${u32(offset + 16, is_little_endian)} | ${u32(offset + 20, is_little_endian)} |  ${u32(offset + 24, is_little_endian)} |  ${u32(offset + 28, is_little_endian)} `

    html += get_world_low_header_2_1(u32(offset + 4, is_little_endian) + offset_mid)
    html += get_world_low_header_2_1(u32(offset + 8, is_little_endian) + offset_mid)
    html += get_world_low_header_2_1(u32(offset + 12, is_little_endian) + offset_mid)
    html += get_world_low_header_2_1(u32(offset + 16, is_little_endian) + offset_mid)
    return html
}
function get_world_low_header_2_1(offset) {
    let html = ''
    html += `<br>---2>---->  ${u32(offset, is_little_endian)} | ${u32(offset + 4, is_little_endian)} | ${u32(offset + 8, is_little_endian)} |  ${u32(offset + 12, is_little_endian)} | F${f32(offset + 16, is_little_endian)} | ${u32(offset + 20, is_little_endian)} |  ${u32(offset + 24, is_little_endian)} |  ${u32(offset + 28, is_little_endian)} `

    for (let i = 0; i < u32(offset + 0, is_little_endian); i++) {
    html += get_world_low_header_2_1_1(u32(offset + 4, is_little_endian) + offset_mid + (i*12))
    }
    for (let i = 0; i < u32(offset + 8, is_little_endian); i++) {
    html += get_world_low_header_2_1_2(u32(offset + 12, is_little_endian) + offset_mid + (i*12))
    }
    return html
}
function get_world_low_header_2_1_1(offset) {
    let html = ''
    html += `<br>---2>---->---1>  F${f32(offset, is_little_endian)} | F${f32(offset + 4, is_little_endian)} | F${f32(offset + 8, is_little_endian)}  `

    return html
}
function get_world_low_header_2_1_2(offset) {
    let html = ''
    html += `<br>---2>---->---2>  F${f32(offset, is_little_endian)} | F${f32(offset + 4, is_little_endian)} | F${f32(offset + 8, is_little_endian)}  `
...
function load_1st_offset_list(offset,amount_1,amount_2,amount_3,mid) {
    let html = `?${offset} | ${amount_1} | ${amount_2} | ${amount_3} | ${mid} `
    let i =0
    for (; i < amount_1; i++) {
        html+=get_offset_list_1_1(offset+(i*8),i)
    }
    for (let ii=0; ii < amount_3; i++,ii++) {
        html+=get_offset_list_1_2(offset+(i*8),ii)
    }
    for (let ii =0; ii < amount_2; i++,ii++) {
        html+=get_offset_list_1_3(offset+(i*8),ii)
    }
        document.getElementById("file_editor").innerHTML = html

}

function get_offset_list_1_1(offset,i) {
    let html = `<br>---1>---${i}> ${u32(offset, is_little_endian)} | [ ${u8(offset + 4, is_little_endian)}, ${u8(offset + 5, is_little_endian)}, ${u8(offset + 6, is_little_endian)}, ${u8(offset + 7, is_little_endian)} ]`

    return html
}function get_offset_list_1_2(offset,i) {
    let html = `<br>---2>---${i}> ${u32(offset, is_little_endian)} | [ ${u8(offset + 4, is_little_endian)}, ${u8(offset + 5, is_little_endian)}, ${u8(offset + 6, is_little_endian)}, ${u8(offset + 7, is_little_endian)} ]`

    return html
}
function get_offset_list_1_3(offset,i) {
    let html = `<br>---3>---${i}> ${u32(offset, is_little_endian)} | [ ${u8(offset + 4, is_little_endian)}, ${u8(offset + 5, is_little_endian)}, ${u8(offset + 6, is_little_endian)}, ${u8(offset + 7, is_little_endian)} ]`
...
function load_2nd_offset_list(offset,amount_1,amount_2,mid) {
    let html = `?${offset} | ${amount_1} | ${amount_2} | ${mid} `
    let i =0
    for (; i < amount_1; i++) {
        html+=get_offset_list_1_1(offset+(i*8),i)
    }
    ...
    for (let ii=0; ii < amount_2; i+=4,ii++) {
        html+=get_offset_list_2_2(offset+i,ii)
    }
    // for (let ii =0; ii < amount_2; i++,ii++) {
    //     html+=get_offset_list_1_3(offset+(i*8),ii)
    // }
...
function get_offset_list_2_2(offset,i) {
    let html = `<br>---2>---${i}> ${u32(offset, is_little_endian)}`
