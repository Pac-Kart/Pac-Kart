         ...
         <table style='width:100%;' >
            <tbody>
               <tr>
                  ...
                  <td class='no_border'>
                  ${genterate_linkbox(id,'sound_controls',TXFA.unordered_sound_controls_28)}
                  </td>
                  <td style="width:10%;white-space:nowrap;" class='no_border'>Sound Controls 2</td>
                  <td class='no_border'>
                  ${genterate_linkbox(id,'sound_controls',TXFA.unordered_sound_controls_36)}
                  </td>
               </tr>  
               <tr>
                  <td style="width:10%;white-space:nowrap;" class='no_border'>Sound Controls 3</td>
                  <td class='no_border'>
                  ${genterate_linkbox(id,'sound_controls',TXFA.unordered_sound_controls_40)}
                  </td>
                  <td style="width:10%;white-space:nowrap;" class='no_border'>Sound Controls 4</td>
                  <td class='no_border'>
                  ${genterate_linkbox(id,'sound_controls',TXFA.unordered_sound_controls_52)}
                  </td>
               </tr>  
               <tr>
