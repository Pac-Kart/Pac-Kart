         ...
         <table style='width:100%;' >
            <tbody>
               <tr>
                  ...
                  <td class='no_border'>
                     ${genterate_linkbox_special(id, TXFA.section_16[0].texture_00)}
                  </td>
   ...
   <div style='padding-bottom:20px'>section_48
      <div class='save_records_boarder'>
        ...
        for (let i = 0; i < TXFA.section_16[0].section_48.length; i++) {
            ...
            // colortxfa.u8_00.toString(16).padStart(2,0)
            ...
            html += `<tr>
               ...
               <td style="width:15%" class='no_border'>
                  <input class='colortemp' style="width:100%" type='text' value="${colortxfa.u8_00}" data-outer_xfa="${id}.section_16[0].section_48[${i}]" data-inner_xfa="u8_00" data-type="u8">
               </td>
               <td style="width:15%" class='no_border'>
                  <input class='colortemp' style="width:100%" type='text' value="${colortxfa.u8_01}" data-outer_xfa="${id}.section_16[0].section_48[${i}]" data-inner_xfa="u8_01" data-type="u8">
               </td>
               <td style="width:15%" class='no_border'>
                  <input class='colortemp' style="width:100%" type='text' value="${colortxfa.u8_02}" data-outer_xfa="${id}.section_16[0].section_48[${i}]" data-inner_xfa="u8_02" data-type="u8">
               </td>
               <td style="width:15%" class='no_border'>
                  <input class='colortemp' style="width:100%" type='text' value="${colortxfa.u8_03}" data-outer_xfa="${id}.section_16[0].section_48[${i}]" data-inner_xfa="u8_03" data-type="u8">
               </td>
               <td style="width:15%" class='no_border'>
