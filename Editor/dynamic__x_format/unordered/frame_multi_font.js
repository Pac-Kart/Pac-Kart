         ...
         <table style='width:100%;' >
            <tbody>
               <tr>
                  ...
                  <td class='no_border'>
                  ${genterate_linkbox(id,'frame_font',TXFA.section_04[0].unordered_frame_font_12)}
                  </td>
                  <td style="width:10%;white-space:nowrap;" class='no_border'>Font 2</td>
                  <td class='no_border'>
                  ${genterate_linkbox(id,'frame_font',TXFA.section_04[0].unordered_frame_font_28)}
                  </td>
               </tr>  
               <tr>
                  <td style="width:10%;white-space:nowrap;" class='no_border'>Font 3</td>
                  <td class='no_border'>
                  ${genterate_linkbox(id,'frame_font',TXFA.section_04[0].unordered_frame_font_32)}
                  </td>
