...
function im_hwvx_gc_file_header(o, i, x) {
    ...
    for (let i = 0; i < u32(12); i++) {
        let a = Date.now()
        im_hwvx_gc_directory(16 + (i * 24), i, x[i].directory, directory_offset)
...
function im_hwvx_gc_directory(o, i, x, global) {
    ...
    case 9:
    case 10:
        // u32(o + 16) ? im_hwvx_gc_datapack(next_offset + u32(o + 20), 0, x[i].section_datapack) : 0;
        break;
    case 7:
        // u32(o + 16) ? im_hwvx_gc_geo_datapack(next_offset + u32(o + 20), 0, x[i].section_datapack) : 0;
        break;
    }
