...
u32(o + 16) ? im_bmg_demo_model_anim_1_type_a(u32(o + 16) + g.m,x[i].section_16) : 0; // offset? 
...
x.push({
 ...
 u32(o + 0) ? im_bmg_demo_model_anim_2_type_b(u32(o + 0) + g.m,x[i].section_0) : 0; // offset? 
...
x.push({
 ...
 u32(o + 48) ? im_bmg_demo_unknown(u32(o + 48) + g.m,x[i].section_48) : 0; // offset? 
u32(o + 88) ? im_bmg_demo_sound_section(u32(o + 88) + g.m,x[i].section_88) : 0; // offset? 
return x[i].id 
// 160 bytes;
...
x.push({
    ...
    texture_72: im_patch(g.texture_patch_ref, o + 72),
    texture_76: im_patch(g.texture_patch_ref, o + 76),
    f32_80: f32(o + 80),
    f32_84: f32(o + 84),
    section_88: [],
    f32_92: f32(o + 92),
