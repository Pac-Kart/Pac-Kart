...
function im_hwvx_pc_directory(o, i, x, global) {
    ...
    case 9:
    case 10:
        // u32(o + 16) ? im_hwvx_pc_datapack(next_offset + u32(o + 20), 0, x[i].section_datapack) : 0;
        break;
    case 7:
        // u32(o + 16) ? im_hwvx_pc_geo_datapack(next_offset + u32(o + 20), 0, x[i].section_datapack) : 0;
        break;
    }
