    ...
    function im_hwvx_pc_triggers_and_actions_4trest(o, x) {
        ...
        for (let i = 0; i < _1st_amnt; i++) {
            get_hwvx_pc_triggers_and_actions_4trest_1st(u32(o + 4) + (i * 4) + g.m, i, x[0].section_2)
        }
        ...
        for (let i = 0; i < _2nd_amnt; i++) {
            get_hwvx_pc_triggers_and_actions_4trest_2nd(u32(o + 4) + (i * 4) + g.m, i, x[0].section_4)
        }
        // 4 bytes;
    }
    
    function get_hwvx_pc_triggers_and_actions_4trest_1st(o, i, x) {
        x.push({
            sec_id: "a????",
            section_0: [],
            type: "?",
    ...
    function get_hwvx_pc_triggers_and_actions_4trest_2nd(o, i, x) {
        x.push({
            sec_id: "b????",
            section_0: [],
            type: "?",
