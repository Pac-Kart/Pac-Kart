...
function get_hwvx_proto_sec_id(string) {
    ...
    case 'taFF':
        ...
        break
    case ':9Xc':
        return "hwvx_proto_world_20_12_16"
        break
    case 'x0l6':
        return "hwvx_proto_world_20_12_16_68"
        break
    case '>je2':
    ...
    case 'e2Rn':
        ...
        break
    case 'NE9?':
        return "hwvx_proto_unknown_small_model_link"
        break
    case 'Pd2k':
        return "hwvx_proto_unknown_small_model_link_12"
        break
    case '^GRl':
...
function im_hwvx_proto_directory(o, i, x) {
    ...
    g = {
        ...
        triggers_and_actions_hold_multilink: [],
    ...
    case 9:
    case 10:
        im_hwvx_proto_datapack(next_offset + u32(o + 20), 0, x[i].section_datapack);
        break;
    case 7:
...
function im_hwvx_proto_ordered(o, x) {
    ...
    case "colliders":
        ...
        break
    case "share":
        im_hwvx_proto_share(o, x[0].hwvx_proto_file_specific_section, x)
        break
    case "world texture":
        // nothing ?
        break
...
function im_hwvx_proto_share(o, x, x_up) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
        sec_id: "FNM8",
    ...
    for (let i = 0; i < u32(g.datapack_offset + 56); i++) {
        im_hwvx_proto_share_4(o + (i * 4), i, x[0].section_0)
    }
    ...
    if (u32(g.datapack_offset + 60) || u32(g.datapack_offset) === get_end) {// no shared section
        ...
        im_hwvx_proto_share_end(get_end + g.m, x_up[0].hwvx_proto_share_end_section)
    }

}

function im_hwvx_proto_share_4(o, i, x) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
        sec_id: "SNM8",
...
function im_hwvx_proto_world(o, x) {
    im_hwvx_proto_world_settings_temp(u32(o + 156) + g.m)
    id_offset.push(o);
    x.push({
        id: gen_id(),
        sec_id: "rjJj",
        ...
        unordered_first_linked_section: "settings",
        unordered_first_linked_section_index: 0,
    });

    g.temp_check_first_section_array = []
    ...
    let check_value = u32(o + 156)
    for (let i = 0; i < g.temp_check_first_section_array.length; i++) {
        if (g.temp_check_first_section_array[0] === 0) {} else {
            if (check_value < g.temp_check_first_section_array[i]) {
                x[0].unordered_first_linked_section = "idk"
                x[0].unordered_first_linked_section_index = i
                i = g.temp_check_first_section_array.length + 1
            }
        }

    }
    if (x[0].unordered_first_linked_section === "settings") {
        let temp = g.temp_check_first_section_array
        temp.sort(function(a, b) {
            return a - b;
        });
        let top_value = temp[temp.length - 1]

        if (top_value < check_value) {
            x[0].unordered_first_linked_section = "all idk"
        }
    }
    ...
    for (let ii = 0; ii < u32(o + 72); ii++) {
        x[0].section_76 = in_ml(u32(o + 76) + (ii * 4), g.hwvx_proto_world_76_array, im_hwvx_proto_world_76, g.unordered_ref.hwvx_proto_world_76);
    }
    for (let ii = 0; ii < u32(o + 80); ii++) {
        x[0].section_84 = in_ml(u32(o + 84) + (ii * 4), g.hwvx_proto_world_84_array, im_hwvx_proto_world_84, g.unordered_ref.hwvx_proto_world_84);
    }
...
function im_hwvx_proto_world_settings_temp(o) {
    let idk = log_array.p_offset.array.indexOf(u32(o + 156))
    if (idk !== -1) {
        log_array.p_offset.array.splice(idk, 1);
    }
    globalThis.hwvx_proto_world_settings_156_index = idk
...
function im_hwvx_proto_world_12(o, i, x) {
    ...
    g.temp_check_first_section_array.push(u32(o + 64))
    g.temp_check_first_section_array.push(u32(o + 68))
    g.temp_check_first_section_array.push(u32(o + 72))
    g.temp_check_first_section_array.push(u32(o + 76))
...
function im_hwvx_proto_world_20_12(o, x) {
    ...
    x.push({
        ...
        u8_7: u8(o + 7),
        f32_8: f32(o + 8),
        unordered_hwvx_proto_world_20_12_16_16: 0,
    });
    x[0].model_0 = in_models(o + 0, g.hwvx_proto_models_array, im_hwvx_proto_models, g.ordered_ref.hwvx_proto_models);
    // x[0].ordered_hwvx_proto_world_20_12_16 = in_ml(u32(o + 16), g.hwvx_proto_car_link_array, im_hwvx_proto_world_20_12_16, g.unordered_ref.hwvx_proto_car_link);
    x[0].unordered_hwvx_proto_world_20_12_16_16 = in_ml(u32(o + 16), g.hwvx_proto_world_20_12_16_array, im_hwvx_proto_world_20_12_16, g.unordered_ref.hwvx_proto_world_20_12_16);

    // 32 bytes;

}
function im_hwvx_proto_world_20_12_16(o, i, x) {
    x.push({
        id: gen_id(),
        sec_id: ":9Xc",
        f32_0: f32(o + 0),
        ...
        f32_32: f32(o + 32),
        f32_40: f32(o + 40),
        unordered_hwvx_proto_car_sub_link_48: 0,
        section_68: [],
    });

    x[i].unordered_hwvx_proto_car_sub_link_48 = in_ml(u32(o + 48), g.hwvx_proto_car_sub_link_array, im_hwvx_proto_car_sub_link, g.unordered_ref.hwvx_proto_car_sub_link);
    u32(o + 68) && im_hwvx_proto_world_20_12_16_68(u32(o + 68) + g.m, x[i].section_68);
    return x[i].id
    // 80 bytes;

}
function im_hwvx_proto_world_20_12_16_68(o, x) {
    x.push({
        sec_id: "x0l6",
        f32_0: f32(o + 0),
        f32_4: f32(o + 4),
...
function im_hwvx_proto_world_36(o, i, x) {
    ...
    for (let ii = 0; ii < u32(o + 24); ii += 32) {
        im_hwvx_proto_world_36_28(u32(o + 28) + ii + g.m, ii, x[i].section_28);
    }
...
function im_hwvx_proto_world_36_48(o, i, x) {
    ...
    for (let ii = 0; ii < u32(o + 4); ii++) {
        im_hwvx_proto_world_36_48_8(u32(o + 8) + (ii * 64) + g.m, ii, x[i].section_8);
    }
    for (let ii = 0; ii < u32(o + 12); ii++) {
        im_hwvx_proto_world_36_48_16(u32(o + 16) + (ii * 64) + g.m, ii, x[i].section_16);
    }
    for (let ii = 0; ii < u32(o + 20); ii++) {
...
function im_hwvx_proto_world_36_48_16(o, i, x) {
    ...
    g.hwvx_proto_world_36_48_16_array.push(o - g.m)
    g.unordered_ref.hwvx_proto_world_36_48_16.push(x[i])
...
function im_hwvx_proto_world_36_48_8(o, i, x) {
    ...
    g.hwvx_proto_world_36_48_8_array.push(o - g.m)
    g.unordered_ref.hwvx_proto_world_36_48_8.push(x[i])
...
function im_hwvx_proto_world_36_48_24(o, i, x) {
    ...
    g.hwvx_proto_world_36_48_24_array.push(o - g.m)
    g.unordered_ref.hwvx_proto_world_36_48_24.push(x[i])
...
function im_hwvx_proto_world_84(o, i, x) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
...
function im_hwvx_proto_collision(o, x) {
    ...
    x.push({
        ...
        section_64_padding: 0,
        section_64_after_buffer: 0,
    });
    ...
    if (collision_amount) {
        let length = (collision_amount * 4)
        let find_next_offset_i = u32(o + 64) + length
        let after_padding = get_next_value_in_array(log_array.p_offset.array, find_next_offset_i - 1)
        x[0].section_64_padding = after_padding - find_next_offset_i

        if (find_next_offset_i !== after_padding) {
            let end_buffer = after_padding + g.m
            let start_buffer = find_next_offset_i + g.m
            x[0].section_64_after_buffer = convert_arraybuffer_base64(buffer.slice(start_buffer, end_buffer))
        }
...
function im_hwvx_proto_collision_32(o, i, x) {
    ...
    x.push({
        ...
        u32_64: u32(o + 64),
        section_68: [],
        section_56_padding: 0,
        section_56_after_buffer: 0,
        section_68_after_buffer: 0,
    });

    if (u32(o + 48)) {
        for (let ii = 0; ii < u32(o + 60); ii++) {
            im_hwvx_proto_collision_32_48(u32(o + 48) + (ii * 32) + g.m, ii, x[i].section_48);
        }
    }

    if (u32(o + 56)) {
        // if (u32(o + 60)) {
        let length = (u32(o + 60) * 4)
        let find_next_offset_i = u32(o + 56) + length
        let after_padding = get_next_value_in_array(log_array.p_offset.array, find_next_offset_i - 1)
        x[i].section_56_padding = after_padding - find_next_offset_i

        if (find_next_offset_i !== after_padding) {
            let end_buffer = after_padding + g.m
            let start_buffer = find_next_offset_i + g.m
            x[i].section_56_after_buffer = convert_arraybuffer_base64(buffer.slice(start_buffer, end_buffer))
        }
        // x[i].section_56_after_buffer = (temp_value + find_next_offset_i) - (u32(o + 56) + (u32(o + 60) * 4))

        // if (x[i].section_56_after_buffer !== 0) {
        //     let end_buffer = (temp_value + find_next_offset_i) + g.m
        //     let start_buffer = end_buffer - x[i].section_56_after_buffer
        //     x[i].section_56_after_buffer = convert_arraybuffer_base64(buffer.slice(start_buffer, end_buffer))
        // }
        for (let ii = 0; ii < u32(o + 60); ii++) {
    ...
    if (u32(o + 68)) {
        if (u32(o + 64)) {
            ...
            let length = (u32(o + 64) * 2)
            let find_next_offset_i = u32(o + 68) + length
            let after_padding = get_next_value_in_array(log_array.p_offset.array, find_next_offset_i - 1)

            if (find_next_offset_i !== after_padding) {
                let end_buffer = after_padding + g.m
                let start_buffer = find_next_offset_i + g.m
                x[i].section_68_after_buffer = convert_arraybuffer_base64(buffer.slice(start_buffer, end_buffer))
            }

            for (let ii = 0; ii < u32(o + 64); ii++) {
                im_hwvx_proto_collision_32_68(u32(o + 68) + (ii * 2) + g.m, ii, x[i].section_68);
            }
        } else {
            x[i].section_68 = u32(o + 68)
        }
    }
}

function im_hwvx_proto_collision_32_68(o, i, x) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
        sec_id: "jPo9",
...
function im_hwvx_proto_triggers_and_actions(o, i, x) {
    ...
    g.actions_end_length = u32(o + 8) * 4

    if (o === 11544232) {
        console.log(11544232)
    }
...
function im_hwvx_proto_triggers_and_actions_4t5(o, x) {
    ...
    case 22:
        ...
        x[0].section_12_type = "float"
        break
    default:
        type_object = hwvx_proto_return_if_value_in_multilink(o + 12)
...
function hwvx_proto_return_if_value_in_multilink(o) {
    ...
    } else if (g.hwvx_proto_world_84_array.includes(check_val)) {
        value_object.section = in_ml(u32(o), g.hwvx_proto_world_84_array, im_hwvx_proto_world_84, g.unordered_ref.hwvx_proto_world_84);
        value_object.type = "hwvx_proto_world_84"
...
function im_hwvx_proto_triggers_and_actions_4trest(o, x) {
    ...
    let check_value = (_1st_amnt * 4) + 4
    if (g.actions_end_length === check_value) {// skip 2nd section
    } else {
...
function im_hwvx_proto_triggers_and_actions_20_4t0(o, x) {
    ...
    let amt = u32(o + 4)
    // for (let i = 0; i < amt; i++) {
    //     x[0].section_2.push(in_ml(u32(o + 8 + (i * 4)), g.hwvx_proto_world_108_44t6_array, im_hwvx_proto_world_108_44t6, g.unordered_ref.hwvx_proto_world_108_44t6));
    // }
    for (let i = 0; i < amt; i++) {
        get_hwvx_proto_triggers_and_actions_4trest_1st(o + 8 + (i * 4), i, x[0].section_2)
    }
...
function im_hwvx_proto_triggers_and_actions_20_4t2(o, x) {
    ...
    for (let i = 0; i < amt; i++) {
        x[0].section_2.push(in_ml(u32(o + 8 + (i * 4)), g.hwvx_proto_world_36_48_8_array, im_hwvx_proto_world_36_48_8, g.unordered_ref.hwvx_proto_world_36_48_8));
    }
...
function im_hwvx_proto_triggers_and_actions_20_4t3(o, x) {
    ...
    for (let i = 0; i < amt; i++) {
        x[0].section_2.push(in_ml(u32(new_o + (i * 4)), g.hwvx_proto_world_36_48_16_array, im_hwvx_proto_world_36_48_16, g.unordered_ref.hwvx_proto_world_36_48_16));
    }
...
function im_hwvx_proto_triggers_and_actions_20_4t5(o, x) {
    ...
    for (let i = 0; i < amt; i++) {
        x[0].section_2.push(in_ml(u32(o + 8 + (i * 4)), g.hwvx_proto_world_36_48_24_array, im_hwvx_proto_world_36_48_24, g.unordered_ref.hwvx_proto_world_36_48_24));
    }
...
function im_hwvx_proto_triggers_and_actions_20_4t7(o, x) {
    ...
    let type_object = hwvx_proto_return_if_value_in_multilink(o + 8)
    x[0].section_8 = type_object.section
    x[0].type = type_object.type
...
function im_hwvx_proto_triggers_and_actions_20_4t8(o, x) {
    ...
    let type_object = hwvx_proto_return_if_value_in_multilink(o + 12)
    x[0].section_12 = type_object.section
    x[0].type = type_object.type
...
function im_hwvx_proto_triggers_and_actions_20_4t12(o, x) {
    ...
    for (let i = 0; i < amt; i++) {
        x[0].section_2.push(in_ml(u32(o + 8 + (i * 4)), g.hwvx_proto_world_120_0_array, im_hwvx_proto_world_120_0, g.unordered_ref.hwvx_proto_world_120_0));
    }
...
function im_hwvx_proto_triggers_and_actions_20_4t17(o, x) {
    ...
    for (let i = 0; i < amt; i++) {
        x[0].section_2.push(in_ml(u32(o + 8 + (i * 4)), g.hwvx_proto_world_12_array, im_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12));
    }
...
function im_hwvx_proto_triggers_and_actions_20_4t22(o, x) {
    ...
    for (let i = 0; i < amt; i++) {
        x[0].section_2.push(in_ml(u32(o + 12 + (i * 4)), g.hwvx_proto_world_12_array, im_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12))
    }
...
function im_hwvx_proto_model_anims_1(o, i, x) {
    ...
    if (u32(o + 36) === u32(o + 44)) {
        // 44 is same
        if (u32(o + 44)) {
            x[i].section_44_temp = true
        }
    } else {
        u32(o + 44) && im_hwvx_proto_model_anims_1_44(u32(o + 44) + g.m, x[i].section_44);
    }
    // for (let ii = 0; ii < u32(o + 48); ii++) {
...
// }
function im_hwvx_proto_model_anims_1_44(o, x) {
    let find_next_offset_i = (o + 1) - g.m
...
function im_hwvx_proto_model_anims_2(o, i, x) {
    ...
    let find_next_offset_i = u32(o + 16)
    x[i].after_section_padding = get_next_value_in_array(log_array.p_offset.array, find_next_offset_i) - find_next_offset_i
...
function im_hwvx_proto_world_settings(o, i, x) {
    ...
    // let idk = log_array.p_offset.array.indexOf(u32(o + 156))
    if (globalThis.hwvx_proto_world_settings_156_index !== -1) {
        x[i].u32_156_is_offset = true
...
function im_hwvx_proto_world_model_related(o, i, x) {
    ...
    switch (u8(o + 4)) {
    case 0:
        x[i].section_0 = in_models(o + 0, g.hwvx_proto_models_array, im_hwvx_proto_models, g.ordered_ref.hwvx_proto_models);
        break;
    case 1:
...
function im_hwvx_proto_geo_list_4(o, i, x) {
    ...
    let idk = log_array.p_offset.array.indexOf(x[i].u32_16)
    if (idk !== -1) {
        log_array.p_offset.array.splice(idk, 1);
        x[i].u32_16_is_offset = true
    }
...
function im_hwvx_proto_car_sub_link(o, i, x) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
        sec_id: "2Ajg",
    ...
    for (let ii = 0; ii < u32(o + 68); ii++) {
        im_hwvx_proto_car_link_48_72(u32(o + 72) + (ii * 4) + g.m, ii, x[i].section_72);
    }

    for (let ii = 0; ii < u32(o + 76); ii++) {
        im_hwvx_proto_car_link_48_72(u32(o + 80) + (ii * 4) + g.m, ii, x[i].section_80);
    }
...
function im_hwvx_proto_model_link(o, i, x) {
    ...
    for (let ii = 0; ii < u32(o + 8); ii++) {
        im_hwvx_proto_model_link_12(u32(o + 12) + (ii * 8) + g.m, ii, x[i].section_12);
    }
...
function im_hwvx_proto_model_link_12(o, i, x) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
        sec_id: "u66W",
...
function im_hwvx_proto_interface_16(o, i, x) {
    ...
    case 2:
        ...
        break;
    case 4:
        u32(o + 20) && im_hwvx_proto_interface_16_20t4(u32(o + 20) + g.m, x[i].section_20);
        break;
    case 10:
        u32(o + 20) && im_hwvx_proto_interface_16_20t10(u32(o + 20) + g.m, x[i].section_20);
        break;
    case 11:
        u32(o + 20) && im_hwvx_proto_interface_16_20t11(u32(o + 20) + g.m, x[i].section_20);
        break;
    }
...
function im_hwvx_proto_interface_16_20t0(o, x) {
    ...
    case 0:
        ...
        break
    case 1:
        x[0].section_4 = in_models(o + 4, g.hwvx_proto_models_array, im_hwvx_proto_models, g.ordered_ref.hwvx_proto_models);
        x[0].section_4_temp = u32(o + 4)
        break
    case 3:
        //nothing
        break
...
function im_hwvx_proto_interface_16_68(o, x) {
    ...
    for (let ii = 0; ii < u32(o + 16); ii++) {
        im_hwvx_proto_interface_16_68_20(u32(o + 20) + (ii * 12) + g.m, ii, x[0].section_20);
    }
...
function im_hwvx_proto_interface_16_68_20(o, i, x) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
        sec_id: "bX^r",
    ...
    u32(o + 8) && im_hwvx_proto_interface_16_68_20_8(u32(o + 8) + g.m, x[i].section_8);
...
function im_hwvx_proto_unknown_4(o, i, x) {
    ...
    case 26:
        ...
        break;
    case 29:
        x[i].section_4 = in_ml(u32(o + 4), g.hwvx_proto_unknown_small_model_link_array, im_hwvx_proto_unknown_small_model_link, g.unordered_ref.hwvx_proto_unknown_small_model_link);
        break;
    default:
        x[i].section_4 = u32(o + 4)
        break
    }
    switch (u32(o + 0)) {
    case 1:
...
function im_hwvx_proto_unknown_4_4t8(o, x) {
    ...
    for (let ii = 0; ii < u32(o + 20); ii++) {
        im_hwvx_proto_unknown_4_4t8_24(u32(o + 24) + (ii * 12) + g.m, ii, x[0].section_24);
    }
...
function im_hwvx_proto_unknown_4_4t8_24(o, i, x) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
        sec_id: "e2Rn",
...
function im_hwvx_proto_unknown_small_model_link(o, i, x) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
        sec_id: "NE9?",
    ...
    for (let ii = 0; ii < u32(o + 8); ii++) {
        im_hwvx_proto_unknown_small_model_link_12(u32(o + 12) + (ii * 48) + g.m, ii, x[i].section_12);
    }
...
function im_hwvx_proto_unknown_small_model_link_12(o, i, x) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
...
function im_hwvx_proto_sound_section(o, i, x) {
    ...
    for (let ii = 0; ii < u32(o + 28); ii++) {
        im_hwvx_proto_sound_section_32(u32(o + 32) + (ii * 12) + g.m, ii, x[i].section_32);
    }
...
function im_hwvx_proto_sound_section_32(o, i, x) {
    id_offset.push(o);
    x.push({
        id: gen_id(),
        sec_id: "ZBz8",
...
function add_hwvx_proto_world_20_12_16() {
    return {
        id: gen_id(),
        sec_id: ":9Xc",
        f32_0: 0,
...
function add_hwvx_proto_world_20_12_16_68() {
    return {
        sec_id: "x0l6",
        f32_0: 0,
        f32_4: 0,
...
function add_hwvx_proto_unknown_small_model_link() {
    return {
        sec_id: "NE9?",
        u32_0: 0,
        u32_4: 0,
...
function add_hwvx_proto_unknown_small_model_link_12() {
    return {
...
function info_hwvx_proto_world_20_12_16() {
    return {
        sec_id: ":9Xc",
        f32_0: 0,
        f32_4: 0,
...
function info_hwvx_proto_world_20_12_16_68() {
    return {
        sec_id: "x0l6",
        f32_0: 0,
        f32_4: 0,
...
function info_hwvx_proto_unknown_small_model_link() {
    return {
        sec_id: "NE9?",
        u32_0: 0,
        u32_4: 0,
...
function info_hwvx_proto_unknown_small_model_link_12() {
    return {
        sec_id: "Pd2k",
        f32_0: 0,
        f32_4: 0,
...
function ex_hwvx_proto_x(o, x) {
    ...
    g = {
        ...
        hwvx_proto_model_array: [],
        temp_hwvx_proto_world_offset_holder: [],
        hwvx_proto_car_sub_link_array: [],
        hwvx_proto_world_20_12_16_array: [],
        hwvx_proto_unknown_small_model_link_array: [],
...
function ex_hwvx_proto_file_header(o, x) {
    ...
    globalThis.directory_offset_array = []
    ...
    for (let i = 0; i < x.directory.length; i++) {
        ...
        su32(temp_offset + 20, globalThis.directory_offset_array[i])
...
function ex_hwvx_proto_directory(o, e, x, global) {
    ...
    g.hwvx_proto_car_sub_link_array = []
    g.hwvx_proto_unknown_small_model_link_array = []
    g.temp_hwvx_proto_world_offset_holder_models = []
    let ce = e
...
function ex_hwvx_proto_datapack(o, x) {
    ...
    */
    ...
    let ordered_length = ex_hwvx_proto_ordered(e, x.ordered[0])
    if (ordered_length === NaN || ordered_length === 0) {
        console.log("?")
    }
    let new_buffer = ordered_buffer.slice(0, ordered_length)
    ...
    */
    ...
    globalThis.patch_buffer = new ArrayBuffer(patch_list_buffer.byteLength + 10000000)
    dynamic_buffer = patch_buffer
    // buffer_array.push(patch_list_buffer)

    let patch_list_length = ex_hwvx_proto_patch_list(x)
    if (patch_list_length === NaN) {
        alert("?")
    }
    new_buffer = patch_list_buffer.slice(0, patch_list_length)
    buffer_array.push(new_buffer)
    ...
    */
    ...
    g.sound_section_length_start = 120
    g.end_sound_impulse_tracker_section = 0
    g.end_sound_offset_section = 0
    ...
    let amount_sounds = 0
    if (x?.section_audio[0]?.sound?.length) {
        amount_sounds = x?.section_audio[0]?.sound?.length
    }
    let amount_color_tables = 0

    su32(0, ordered_length)
    su32(4, audio_length)
    su32(8, amount_sounds)
    su32(12, g.oa.length)
    su32(16, g.texture_patch_array.length)
    su32(20, x.section_24.length)
    su32(24, g.texture_offset_hold)
    su32(28, g.sound_patch_array.length)
    su32(32, amount_sounds)
    su32(40, x.section_44.length)
    ...
    su32(64, x.section_68.length)
    su32(68, g.triggers_and_actions_offset_hold)
    su32(72, impulse_tracker_offset)
    su32(76, audio_data_2_offset)
    ex_string(80, 80, x.section_80, 1, 0)
    su32(92, x.u32_92)
    ex_string(100, 100, x.section_100, 1, 0)
    su32(112, x.u32_112)

    buffer_array[buffer_array.length - 1] = datapack_buffer.slice(0, datapack_length)
    ...
    */
    ...
    let file_length = ordered_length + datapack_length + patch_list_length
...
function ex_hwvx_proto_patch_list(x) {
    let length = 0;
    length += (g.texture_patch_array.length + g.sound_patch_array.length + g.animation_patch_array.length + g.model_patch_array.length) * 8
    length += g.oa.length * 4
    ...
    i++) {
        if (x.patch_list[0].texture[t_i][0] !== g.texture_patch_array[t_i][0]) {
            console.log(`
            wrong texture offset| prev is:  ${x.patch_list[0].texture[t_i - 1][0]} | mid ${x.patch_list[0].texture[t_i - 1][0] + x.gm}
            yay: ${x.patch_list[0].texture[t_i][0]} | mid ${x.patch_list[0].texture[t_i][0] + x.gm}
            nah: ${g.texture_patch_array[t_i][0]} | mid ${g.texture_patch_array[t_i][0] + x.gm}
            t_i: ${t_i}
            `)
            return
        }
    ...
    i++) {
        if (x.patch_list[0].texture_animation[ta_i][0] !== g.animation_patch_array[ta_i][0]) {
            console.log(`
            wrong texture_animation offset  | prev is:  ${x.patch_list[0].texture_animation[ta_i - 1][0]} | mid ${x.patch_list[0].texture_animation[ta_i - 1][0] + x.gm}
            yay: ${x.patch_list[0].texture_animation[ta_i][0]} | mid ${x.patch_list[0].texture_animation[ta_i][0] + x.gm}
            nah: ${g.animation_patch_array[ta_i][0]} | mid:  ${g.animation_patch_array[ta_i][0] + x.gm}
            ta_i: ${ta_i}
            `)
            return
        }
    ...
    i++) {
        if (x.patch_list[0].sound[s_i][0] !== g.sound_patch_array[s_i][0]) {
            console.log(`
            wrong sound offset | prev is:  ${x.patch_list[0].sound[s_i - 1][0]} | mid ${x.patch_list[0].sound[s_i - 1][0] + x.gm}
            yay: ${x.patch_list[0].sound[s_i][0]} | mid ${x.patch_list[0].sound[s_i][0] + x.gm}
            nah: ${g.sound_patch_array[s_i][0]} | mid ${g.sound_patch_array[s_i][0] + x.gm}
            s_i: ${s_i}
            `)
            return
        }
    ...
    i++) {
        if (x.patch_list[0].model[m_i][0] !== g.model_patch_array[m_i][0]) {
            let extra_text = ''
            if (m_i !== 0) {
        ...
        su32((i * 8), g.model_patch_array[m_i][0])
        su16((i * 8) + 4, g.model_patch_array[m_i][1])
        su16((i * 8) + 6, g.model_patch_array[m_i][2])
    }
    let e = i * 8
    i = 0
...
function ex_hwvx_proto_geo_datapack(o, x) {
    ...
    */
    ...
    let ordered_list_buffer = convert_base64_arraybuffer(x.ordered_buffer)
    globalThis.ordered_buffer = new ArrayBuffer(ordered_list_buffer.byteLength + 100000000)
    dynamic_buffer = ordered_buffer

    let ordered_length = ex_hwvx_proto_geo_basic(0, x.ordered[0])
    if (ordered_length === NaN || ordered_length === 0) {
        console.log("?")
    }
    let new_buffer = ordered_buffer.slice(0, ordered_length)
    ...
    */
    ...
    new_buffer = patch_buffer.slice(0, patch_list_length)
    buffer_array.push(new_buffer)
    ...
    */
    ...
    su32(0, ordered_length)
    su32(4, g.oa.length)
    su32(8, g.texture_patch_array.length)
    su32(28, g.animation_patch_array.length)
    su32(36, x.u32_36)
    su32(40, g.model_patch_array.length)
    ex_string(44, 44, x.section_44, 1, 0)
    su32(56, x.u32_56)

    let file_length = ordered_length + globalThis.datapack_buffer.byteLength + patch_list_length
    globalThis.directory_length_array.push(file_length)
...
function ex_hwvx_proto_sound_offset_list(o, x) {
    ...
    g.sound_section_length_start = e
    let base_offset = e
    e += sound_length * 32
    e += x.padding
...
function ex_hwvx_proto_impulse_tracker(o, x) {
    if (x.length) {
        ...
        new Uint8Array(dynamic_buffer).set(new Uint8Array(buffer), o)
        g.end_sound_impulse_tracker_section = buffer.byteLength
        return o + buffer.byteLength
    }
    return o
}
function ex_hwvx_proto_audio_data_2(o, x) {
    if (x.length) {
        let buffer = convert_base64_arraybuffer(x[0].buffer)
        new Uint8Array(dynamic_buffer).set(new Uint8Array(buffer), o)
        g.end_sound_offset_section = buffer.byteLength
        return o + buffer.byteLength
    }
    return o
}
...
function ex_hwvx_proto_ordered(o, x) {
    ...
    case "colliders":
        ...
        break
    case "share":
        e = ex_hwvx_proto_share(o, x.hwvx_proto_file_specific_section[0], x.hwvx_proto_share_end_section[0])
        break
    case "world texture":
        e = ex_hwvx_proto_ordered_list_layout(o)
        break
    default:
        console.pk_log('file type is not set')
    }

    if (g.triggers_and_actions_hold_multilink.length) {
        e = ex_hwvx_proto_triggers_and_actions_hold(e)
    }

    if (g.hwvx_proto_texture_anims_old_offsets.length) {
        e = ex_ma(g.unordered_ref.hwvx_proto_texture_anims_0, g.hwvx_proto_texture_anims_0_array, ex_hwvx_proto_texture_anims_0, e, g.m)
    }
    g.hwvx_proto_texture_anims_old_offsets = []

    if (g.file_dir_type === 'world texture') {} else {
        let current_patch_list_divis = divisible(g.divisible_prev_value[0], g.divisible_prev_value[1])
        let patch_list_divis = divisible(g.divisible_prev_value[0], 4)
...
function ex_hwvx_proto_unordered(x) {
    ...
    generate_id_offset_array(g.hwvx_proto_world_84_array = [], x.hwvx_proto_world_84)
    ...
    generate_id_offset_array(g.hwvx_proto_model_array = [], g.ordered_ref.hwvx_proto_models)
    generate_id_offset_array(g.hwvx_proto_car_sub_link_array = [], x.hwvx_proto_car_sub_link)
    generate_id_offset_array(g.hwvx_proto_world_20_12_16_array = [], x.hwvx_proto_world_20_12_16)
    generate_id_offset_array(g.hwvx_proto_unknown_small_model_link_array = [], x.hwvx_proto_unknown_small_model_link)

}
function ex_hwvx_proto_ordered_list_layout(o) {
    let e = o
    g.triggers_and_actions_offset_hold = 0
    g.triggers_and_actions_hold_multilink = []
    if (g.datapack_ref.section_68.length) {
        g.triggers_and_actions_offset_hold = e
        g.triggers_and_actions_offset_hold_data = e + divisible(g.datapack_ref.section_68.length * 44, 16)
        e = ex_ma(g.datapack_ref.section_68, g.hwvx_proto_triggers_and_actions_array, ex_hwvx_proto_triggers_and_actions, e, g.m)
        e = g.triggers_and_actions_offset_hold_data
    }

    if (g.ordered_ref.hwvx_proto_models.length) {
        e = ex_ma(g.ordered_ref.hwvx_proto_models, g.hwvx_proto_model_array, ex_hwvx_proto_models, e, g.m)
    }

    g.tex_anims_hold_offset = 0
...
function ex_hwvx_proto_triggers_and_actions_hold(o) {
    let e = o

    let hold = g.triggers_and_actions_hold_multilink

    // ex_hwvx_proto_models
    for (let i = 0; i < hold.length; i++) {
        // if (hold[i][2].name === "ex_pmwr_pc_world_20_12t4") {
        //     e = ex_ml(hold[i][0], hold[i][1], hold[i][2], hold[i][3], hold[i][4], e, hold[i][6], true)
        // } else if (hold[i][2].name === "ex_pmwr_pc_world_20_12t8") {
        //     e = ex_ml(hold[i][0], hold[i][1], hold[i][2], hold[i][3], hold[i][4], e, hold[i][6], true)
        // } else if (hold[i][2].name === "ex_pmwr_pc_model_animation_1") {
        //     e = ex_ml(hold[i][0], hold[i][1], hold[i][2], hold[i][3], hold[i][4], e, hold[i][6], true)
        // } else {
        e = ex_ml(hold[i][0], hold[i][1], hold[i][2], hold[i][3], hold[i][4], e, hold[i][6])
        // }
    }
...
function ex_hwvx_proto_geo_ordered_list_layout(o) {
    let e = o
    if (g.datapack_ref.models.length) {
        e = ex_ma(g.datapack_ref.models, g.hwvx_proto_model_array, ex_hwvx_proto_models, e, g.m)
    }
...
function ex_hwvx_proto_basic(o, x) {
    ...
    e = ex_s_offset(o + 4, e, ex_hwvx_proto_basic_4, x.section_4, 'up');
...
function ex_hwvx_proto_geo_basic(o, x) {
    ...
    let geo_list = x.section_0

    generate_id_offset_array(g.hwvx_proto_model_array = [], g.datapack_ref.models)
    let section_0_offset = e
    let end_block = (geo_list.length * 12) + section_0_offset
    let temp_offset = divisible(end_block, 16)
    // e = (end_block * 12) + o
    ...
    e = ex_hwvx_proto_geo_ordered_list_layout(temp_offset)

    if (geo_list.length) {
        su32(o + 0, section_0_offset - g.m)
        for (let i = 0; i < geo_list.length; i++) {
            ex_hwvx_proto_geo_basic_0(section_0_offset + (i * 12), e, x.section_0[i])
        }
    }
    ...
    //     ;
    // }
    e = ex_s_offset(o + 4, e, ex_hwvx_proto_geo_list, x.section_4, 'up');
...
function ex_hwvx_proto_geo_basic_0(o, e, x) {
    su32(o + 0, x.u32_0)
    e = ex_ml(x.model_8, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.datapack_ref.models, o + 8, e, 'none', true, "model");

    g.debug && ex_debug(o, x.sec_id);
    return e
}
function ex_hwvx_proto_share(o, x, x_end_share) {

    let share_list = x.section_0

    let end_block = (share_list.length)
    ...
    for (let i = 0; i < share_list.length; i++) {
        ex_hwvx_proto_share_model_list(o + (i * 4), e, x.section_0[i])
    }

    if (x_end_share) {
        e = ex_hwvx_proto_share_end(e, x_end_share)
    }

    g.debug && ex_debug(o, x.sec_id);
    return e
}
function ex_hwvx_proto_share_model_list(o, e, x) {
    // let e = o + divisible(16, g.divisibility)
    e = ex_ml(x.model_0, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.ordered_ref.hwvx_proto_models, o + 0, e, 'none', true, "model");
...
function ex_hwvx_proto_world(o, x) {
    ...
    if (x.unordered_first_linked_section === "settings") {
        g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_world_settings_156, g.hwvx_proto_world_settings_array, ex_hwvx_proto_world_settings, g.unordered_ref.hwvx_proto_world_settings, o + 156, e, 'none']);
    }

    if (g.unordered_ref.hwvx_proto_world_12.length) {
        su32(o + 8, g.unordered_ref.hwvx_proto_world_12.length)
        su32(o + 12, e - g.m)
        g.oa.push(o + 12)
        let temp_offset = e
        g.temp_ma_offset_hold = e + (g.unordered_ref.hwvx_proto_world_12.length * 96)
        e = ex_ma(g.unordered_ref.hwvx_proto_world_12, g.hwvx_proto_world_12_array, ex_hwvx_proto_world_12, e, g.m);
        e = g.temp_ma_offset_hold
    }
    // x.unordered_hwvx_proto_world_idk_76, g.hwvx_proto_world_idk_array, ex_hwvx_proto_world_idk, g.unordered_ref.hwvx_proto_world_idk, o + 76, e, 'down']);
    if (x.unordered_first_linked_section === "idk") {
        let temp_array = g.temp_hwvx_proto_world_offset_holder.slice(0, x.unordered_first_linked_section_index)
        temp_array.push([x.unordered_hwvx_proto_world_settings_156, g.hwvx_proto_world_settings_array, ex_hwvx_proto_world_settings, g.unordered_ref.hwvx_proto_world_settings, o + 156, e, 'none']);
        temp_array.push(...g.temp_hwvx_proto_world_offset_holder.slice(x.unordered_first_linked_section_index, g.temp_hwvx_proto_world_offset_holder.length))
        g.temp_hwvx_proto_world_offset_holder = temp_array
    }

    if (x.unordered_first_linked_section === "all idk") {
        g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_world_settings_156, g.hwvx_proto_world_settings_array, ex_hwvx_proto_world_settings, g.unordered_ref.hwvx_proto_world_settings, o + 156, e, 'none']);
    }

    ;if (g.unordered_ref.hwvx_proto_world_20.length) {
        su32(o + 16, g.unordered_ref.hwvx_proto_world_20.length)
        su32(o + 20, e - g.m)
        g.oa.push(o + 20)
        let temp_offset = e
        g.temp_ma_offset_hold = e + divisible(g.unordered_ref.hwvx_proto_world_20.length * 20, 16)
        e = ex_ma(g.unordered_ref.hwvx_proto_world_20, g.hwvx_proto_world_20_array, ex_hwvx_proto_world_20, e, g.m);
        e = g.temp_ma_offset_hold
    }
    ;if (x.section_36.length) {
        ...
        g.oa.push(o + 36)
        let temp_offset = e
        e += divisible(x.section_36.length * 64, 16)
        for (let i = 0; i < x.section_36.length; i++) {
            e = ex_hwvx_proto_world_36(temp_offset + (i * 64), e, x.section_36[i])
        }
        ;
    }
    ;if (x.section_44.length) {
        ...
        for (let i = 0; i < x.section_44.length; i++) {
            e = ex_hwvx_proto_world_44(temp_offset + (i * 64), e, x.section_44[i])
        }
        ;
    }
    ;e = ex_s_offset(o + 116, e, ex_hwvx_proto_world_116, x.section_116, 'down');

    if (g.unordered_ref.hwvx_proto_world_76.length) {
        su32(o + 72, g.unordered_ref.hwvx_proto_world_76.length)
        su32(o + 76, e - g.m)
        g.oa.push(o + 76)
        let temp_offset = e
        g.temp_ma_offset_hold = e + divisible(g.unordered_ref.hwvx_proto_world_76.length * 4, 16)
        ex_ma(g.unordered_ref.hwvx_proto_world_76, g.hwvx_proto_world_76_array, ex_hwvx_proto_world_76, e, g.m);
        e = g.temp_ma_offset_hold
    }
    ;if (g.unordered_ref.hwvx_proto_world_84.length) {
        su32(o + 80, g.unordered_ref.hwvx_proto_world_84.length)
        su32(o + 84, e - g.m)
        g.oa.push(o + 84)
        let temp_offset = e

        g.temp_ma_offset_hold = e + divisible(g.unordered_ref.hwvx_proto_world_84.length * 4, 16)
        ex_ma(g.unordered_ref.hwvx_proto_world_84, g.hwvx_proto_world_84_array, ex_hwvx_proto_world_84, e, g.m);
        e = g.temp_ma_offset_hold

        // e += divisible(x.section_84.length * 4, 16)
        // for (let i = 0; i < x.section_84.length; i++) {
        //     e = ex_hwvx_proto_world_76(temp_offset + (i * 4), e, x.section_84[i])
        // }
        // ;
    }
    ;if (x.section_92.length) {
        ...
        g.oa.push(o + 92)
        let temp_offset = e
        e += divisible(x.section_92.length * 8, 16)
        for (let i = 0; i < x.section_92.length; i++) {
            e = ex_hwvx_proto_world_92(temp_offset + (i * 8), e, x.section_92[i])
        }
        ;
    }

    ;if (g.unordered_ref.hwvx_proto_world_52.length) {
        su32(o + 48, g.unordered_ref.hwvx_proto_world_52.length)
        su32(o + 52, e - g.m)
        g.oa.push(o + 52)
        let temp_offset = e
        g.temp_ma_offset_hold = e + (g.unordered_ref.hwvx_proto_world_52.length * 112)
        e = ex_ma(g.unordered_ref.hwvx_proto_world_52, g.hwvx_proto_world_52_array, ex_hwvx_proto_world_52, e, g.m)
        e = g.temp_ma_offset_hold;
    }
    ;if (x.section_100.length) {
        ...
        g.oa.push(o + 100)
        let temp_offset = e
        e += divisible(x.section_100.length * 16, 16)
        for (let i = 0; i < x.section_100.length; i++) {
            e = ex_hwvx_proto_world_100(temp_offset + (i * 16), e, x.section_100[i])
        }
        ;
    }
    ;if (g.unordered_ref.hwvx_proto_world_108.length) {
        su32(o + 104, g.unordered_ref.hwvx_proto_world_108.length)
        su32(o + 108, e - g.m)
        g.oa.push(o + 108)
        let temp_offset = e

        // e += divisible(g.unordered_ref.hwvx_proto_world_108.length * 48, 16)

        // for (let i = 0; i < g.unordered_ref.hwvx_proto_world_108.length; i++) {
        //     e = ex_hwvx_proto_world_108(temp_offset + (i * 48), e, g.unordered_ref.hwvx_proto_world_108[i])
        // }
        g.temp_ma_offset_hold = e + (g.unordered_ref.hwvx_proto_world_108.length * 48)
        e = ex_ma(g.unordered_ref.hwvx_proto_world_108, g.hwvx_proto_world_108_array, ex_hwvx_proto_world_108, temp_offset, g.m)
        e = g.temp_ma_offset_hold
    }
    if (x.unordered_hwvx_proto_world_settings_156) {
        g.oa.push(o + 156)
    }
    ;e = ex_s_offset(o + 4, e, ex_hwvx_proto_world_4, x.section_4, 'up');

    e = ex_s_offset(o + 120, e, ex_hwvx_proto_world_120, x.section_120, 'up');

    e = ex_hwvx_proto_ordered_list_layout(e)

    e = ex_hwvx_proto_world_hold(e)

    g.debug && ex_debug(o, x.sec_id);
    return e
}

function ex_hwvx_proto_world_hold(o) {
    let e = o

    let model_hold = g.temp_hwvx_proto_world_offset_holder_models
    for (let i = 0; i < model_hold.length; i++) {
        e = ex_ml(model_hold[i][0], model_hold[i][1], model_hold[i][2], model_hold[i][3], model_hold[i][4], e, model_hold[i][6], model_hold[i][7], model_hold[i][8])

        // e = ex_ml(hold[i][0], hold[i][1], hold[i][2], hold[i][3], hold[i][4], e, hold[i][6])
        // }
    }
    let hold = g.temp_hwvx_proto_world_offset_holder
...
function ex_hwvx_proto_world_12(o, x) {
...
function ex_hwvx_proto_world_20(o, x) {
    let e = g.temp_ma_offset_hold
    su32(o + 0, x.u32_0)
    sf32(o + 8, x.f32_8)

    g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_model_anims_1_4, g.hwvx_proto_model_anims_1_array, ex_hwvx_proto_model_anims_1, g.unordered_ref.hwvx_proto_model_anims_1, o + 4, e, 'none']);
    g.oa.push(o + 4)

    e = ex_s_offset(o + 12, e, ex_hwvx_proto_world_20_12, x.section_12, 'up');
...
function ex_hwvx_proto_world_20_12(o, x) {
    ...
    // ex_patch(o + 0, g.hwvx_proto_model_array, x.model_0)
    su8(o + 5, x.u8_5)
    su8(o + 7, x.u8_7)
    sf32(o + 8, x.f32_8)

    g.temp_hwvx_proto_world_offset_holder_models.push([x.model_0, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.ordered_ref.hwvx_proto_models, o + 0, e, 'none', true, "model"]);
    // g.model_patch_array.push(x.model_0)
    // g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_car_link_16, g.hwvx_proto_car_link_array, ex_hwvx_proto_car_link, g.unordered_ref.hwvx_proto_car_link, o + 16, e, 'down']);
    ...
    e = ex_ml(x.unordered_hwvx_proto_world_20_12_16_16, g.hwvx_proto_world_20_12_16_array, ex_hwvx_proto_world_20_12_16, g.unordered_ref.hwvx_proto_world_20_12_16, o + 16, e, 'up');

    g.debug && ex_debug(o, x.sec_id);
    return e
}
function ex_hwvx_proto_world_20_12_16(o, x) {
    let e = o + 80
    sf32(o + 0, x.f32_0)
    sf32(o + 4, x.f32_4)
    sf32(o + 8, x.f32_8)
    ...
    e = ex_s_offset(o + 68, e, ex_hwvx_proto_world_20_12_16_68, x.section_68, 'down');
    g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_car_sub_link_48, g.hwvx_proto_car_sub_link_array, ex_hwvx_proto_car_sub_link, g.unordered_ref.hwvx_proto_car_sub_link, o + 48, e, 'none']);
    g.oa.push(o + 48)

    g.debug && ex_debug(o, x.sec_id);
    return e
}
function ex_hwvx_proto_world_20_12_16_68(o, x) {
    let e = o + 48
    sf32(o + 0, x.f32_0)
    sf32(o + 4, x.f32_4)
    sf32(o + 8, x.f32_8)
...
function ex_hwvx_proto_world_36(o, e, x) {
    ...
    su32(o + 32, x.u32_32);
    e = ex_ml(x.unordered_hwvx_proto_world_36_36, g.hwvx_proto_world_36_36_array, ex_hwvx_proto_world_36_36, g.unordered_ref.hwvx_proto_world_36_36, o + 36, e, 'down');

    if (x.section_28.length) {
        su32(o + 24, x.section_28.length * 32)
        su32(o + 28, e - g.m)
        g.oa.push(o + 28)
        let temp_offset = e
        e += divisible(x.section_28.length * 32, 16)
        for (let i = 0; i < x.section_28.length; i++) {
            e = ex_hwvx_proto_world_36_28(temp_offset + (i * 32), e, x.section_28[i])
        }
        ;
    }
    e = ex_ml(x.unordered_hwvx_proto_strange_world_36_48, g.hwvx_proto_world_36_48_array, ex_hwvx_proto_world_36_48, g.unordered_ref.hwvx_proto_world_36_48, o + 48, e, 'up');
...
function ex_hwvx_proto_world_36_48(o, x) {
    ...
    if (x.section_8.length) {
        ...
        for (let i = 0; i < x.section_8.length; i++) {
            ex_hwvx_proto_world_36_48_8(temp_offset + (i * 64), e, x.section_8[i])
        }
    }
    ...
    if (x.section_16.length) {
        ...
        g.oa.push(o + 16)
        let temp_offset = e
        e += divisible(x.section_16.length * 64, 16)
        for (let i = 0; i < x.section_16.length; i++) {
            ex_hwvx_proto_world_36_48_16(temp_offset + (i * 64), e, x.section_16[i])
        }
    }
    ...
    if (x.section_24.length) {
        ...
        g.oa.push(o + 24)
        let temp_offset = e
        e += divisible(x.section_24.length * 64, 16)
        for (let i = 0; i < x.section_24.length; i++) {
            ex_hwvx_proto_world_36_48_24(temp_offset + (i * 64), e, x.section_24[i])
        }
    }
...
function ex_hwvx_proto_world_36_48_16(o, e, x) {
    ...
    g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_strange_36, g.hwvx_proto_strange_array, ex_hwvx_proto_strange, g.unordered_ref.hwvx_proto_strange, o + 36, e, 'none']);
    g.oa.push(o + 36)

    let index = g.hwvx_proto_world_36_48_16_array[0].a_ids.indexOf(x.id)
    g.hwvx_proto_world_36_48_16_array[0].a_offsets[index] = o
...
function ex_hwvx_proto_world_36_48_8(o, e, x) {
    ...
    g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_world_model_related_36, g.hwvx_proto_world_model_related_array, ex_hwvx_proto_world_model_related, g.unordered_ref.hwvx_proto_world_model_related, o + 36, e, 'none']);
    g.oa.push(o + 36)

    let index = g.hwvx_proto_world_36_48_8_array[0].a_ids.indexOf(x.id)
    g.hwvx_proto_world_36_48_8_array[0].a_offsets[index] = o
...
function ex_hwvx_proto_world_36_48_24(o, e, x) {
    ...
    let index = g.hwvx_proto_world_36_48_24_array[0].a_ids.indexOf(x.id)
    g.hwvx_proto_world_36_48_24_array[0].a_offsets[index] = o
...
function ex_hwvx_proto_world_44(o, e, x) {
    ...
    if (x.unordered_hwvx_proto_sound_section_20) {
        g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_sound_section_20, g.hwvx_proto_sound_section_array, ex_hwvx_proto_sound_section, g.unordered_ref.hwvx_proto_sound_section, o + 20, e, 'none']);
        g.oa.push(o + 20)
    }
...
function ex_hwvx_proto_world_84(o, x) {
    let e = g.temp_ma_offset_hold
    g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_world_small_section_0, g.hwvx_proto_world_small_section_array, ex_hwvx_proto_world_small_section, g.unordered_ref.hwvx_proto_world_small_section, o + 0, e, 'none']);
    g.oa.push(o + 0)
...
function ex_hwvx_proto_world_52(o, x) {
    let e = g.temp_ma_offset_hold
    sf32(o + 0, x.f32_0)
    sf32(o + 4, x.f32_4)
    sf32(o + 8, x.f32_8)
...
function ex_hwvx_proto_world_92(o, e, x) {
    ...
    if (x.unordered_hwvx_proto_world_text_link_4) {
        g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_world_text_link_4, g.hwvx_proto_world_text_link_array, ex_hwvx_proto_world_text_link, g.unordered_ref.hwvx_proto_world_text_link, o + 4, e, 'none']);
        g.oa.push(o + 4)
    }
...
function ex_hwvx_proto_world_100(o, e, x) {
    su32(o + 0, x.u32_0)
    su32(o + 8, x.u32_8)

    g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_world_color_section_4, g.hwvx_proto_world_color_section_array, ex_hwvx_proto_world_color_section, g.unordered_ref.hwvx_proto_world_color_section, o + 4, e, 'none']);
    g.oa.push(o + 4)
    g.debug && ex_debug(o, x.sec_id);
    return e
}
function ex_hwvx_proto_world_108(o, x) {
    let e = g.temp_ma_offset_hold
    su32(o + 0, x.u32_0)
    su32(o + 4, x.u32_4)
    su32(o + 8, x.u32_8)
...
function ex_hwvx_proto_world_108_40(o, x) {
    let e = o + divisible(384, g.divisibility)
    sf32(o + 0, x.f32_0)
    sf32(o + 4, x.f32_4)
    sf32(o + 8, x.f32_8)
    sf32(o + 12, x.f32_12)
...
function ex_hwvx_proto_world_4_16_4(o, e, x) {
    ...
    g.temp_hwvx_proto_world_offset_holder.push([x.unordered_hwvx_proto_world_108_0, g.hwvx_proto_world_108_array, ex_hwvx_proto_world_108, g.unordered_ref.hwvx_proto_world_108, o + 0, e, 'none']);
    g.oa.push(o + 0)
...
function ex_hwvx_proto_world_120(o, x) {
    ...
    su8(o + 10, x.u8_10)
    su8(o + 11, x.u8_11);
    if (x.unordered_hwvx_proto_world_120_0_0 !== 0) {

        if (g.unordered_ref.hwvx_proto_world_120_0.length) {
            su32(o + 4, g.unordered_ref.hwvx_proto_world_120_0.length)
            su32(o + 0, e - g.m)
            g.oa.push(o + 0)
            let temp_offset = e
            g.temp_ma_offset_hold = e + (g.unordered_ref.hwvx_proto_world_120_0.length * 112)
            e = ex_ma(g.unordered_ref.hwvx_proto_world_120_0, g.hwvx_proto_world_120_0_array, ex_hwvx_proto_world_120_0, e, g.m)
            e = g.temp_ma_offset_hold
        }
    }
...
function ex_hwvx_proto_world_120_0(o, x) {
    let e = g.temp_ma_offset_hold
    sf32(o + 0, x.f32_0)
    sf32(o + 4, x.f32_4)
    sf32(o + 8, x.f32_8)
...
function ex_hwvx_proto_collision(o, x) {
    ...
    //amount?   su32(o +72, x.u32_72)
    //amount?   su32(o +80, x.u32_80)
    su32(o + 88, x.u32_88)// g.temp_hwvx_proto_collision_76_16_holder = []
    ...
    if (x.section_76.length) {
        ...
        for (let i = 0; i < x.section_76.length; i++) {
            e = ex_hwvx_proto_collision_76(temp_offset + (i * 32), e, x.section_76[i])
        }
        ;
    }
    ;if (x.section_84.length) {
        ...
        g.oa.push(o + 84)
        let temp_offset = e
        e += divisible(x.section_84.length * 48, 16)
        for (let i = 0; i < x.section_84.length; i++) {
            e = ex_hwvx_proto_collision_84(temp_offset + (i * 48), e, x.section_84[i])
        }
        ;
    }
    ...
    if (x.section_64.length) {
        ...
        e += x.section_64.length * 4

        if (x.section_64_after_buffer !== 0) {
            let buffer = convert_base64_arraybuffer(x.section_64_after_buffer)
            new Uint8Array(dynamic_buffer).set(new Uint8Array(buffer), e)

            e += buffer.byteLength
        }

        // let temp_e = x.section_64.length * 4
        // replacement_divisibility(temp_e, temp_e + (x.section_64.length *4), temp_e, 205)
        // replacement_divisibility(e, e + (x.section_64.length * 4), e, 205)
        // e += divisible(x.section_64.length * 4, 16)
        // replacement_divisibility(e, e + x.padding_16, e, 205)

        for (let i = 0; i < x.section_64.length; i++) {
            e = ex_hwvx_proto_collision_64(temp_offset + (i * 4), e, x.section_64[i])
        }
        ;
    }
    ...
    e = ex_ml(x.unordered_hwvx_proto_collision_link_92, g.hwvx_proto_collision_link_array, ex_hwvx_proto_collision_link, g.unordered_ref.hwvx_proto_collision_link, o + 92, e, 'up');
...
function ex_hwvx_proto_collision_32(o, e, x) {
    ...
    if (x.section_48.length) {
        ...
        g.oa.push(o + 48)
        let temp_offset = e
        e += divisible(x.section_48.length * 32, 16)
        for (let i = 0; i < x.section_48.length; i++) {
            ex_hwvx_proto_collision_32_48(temp_offset + (i * 32), e, x.section_48[i])
        }

        // for (let i = 0; i < g.hwvx_proto_collision_32_48_array.length; i++) {
        //     ex_ml(x.hwvx_proto_collision_32_48_48, g.hwvx_proto_collision_32_48_array, ex_hwvx_proto_collision_32_48, g.unordered_ref.hwvx_proto_collision_32_48, o + 48, e, 'down');
        // }
        ;
    }
    ;if (x.section_56.length) {
        ...
        g.oa.push(o + 56)
        let temp_offset = e
        e += (x.section_56.length * 4)

        if (x.section_56_after_buffer !== 0) {
            let buffer = convert_base64_arraybuffer(x.section_56_after_buffer)
            new Uint8Array(dynamic_buffer).set(new Uint8Array(buffer), e)
        ...
        for (let i = 0; i < x.section_56.length; i++) {
            e = ex_hwvx_proto_collision_32_56(temp_offset + (i * 4), e, x.section_56[i])
        }
        ;
    }
    ;if (x.u32_64) {
        ...
        g.oa.push(o + 68)
        let temp_offset = e
        e += (x.section_68.length * 2)

        if (x.section_68_after_buffer !== 0) {
            let buffer = convert_base64_arraybuffer(x.section_68_after_buffer)
            new Uint8Array(dynamic_buffer).set(new Uint8Array(buffer), e)
        ...
        for (let i = 0; i < x.section_68.length; i++) {
            e = ex_hwvx_proto_collision_32_68(temp_offset + (i * 2), e, x.section_68[i])
        }
    } else {
        if (typeof x.section_68 === "number") {
            su32(o + 68, e - g.m)
            g.oa.push(o + 68)
        }
    }
...
function ex_hwvx_proto_collision_32_68(o, e, x) {
    su8(o + 0, x.u8_0)
    su8(o + 1, x.u8_1)
...
function ex_hwvx_proto_collision_76(o, e, x) {
    ...
    // g.temp_hwvx_proto_collision_76_16_holder([])
...
function ex_hwvx_proto_collision_link(o, x) {
    ...
    if (x.unordered_hwvx_proto_collision_settings_0) {
        g.oa.push(o)
    }

    if (x.unordered_hwvx_proto_collision_settings_4) {
        g.oa.push(o + 4)
    }

    e = ex_hwvx_proto_ordered_list_layout(e)

    e = ex_ml(x.unordered_hwvx_proto_collision_settings_0, g.hwvx_proto_collision_settings_array, ex_hwvx_proto_collision_settings, g.unordered_ref.hwvx_proto_collision_settings, o + 0, e, 'none');
    e = ex_ml(x.unordered_hwvx_proto_collision_settings_4, g.hwvx_proto_collision_settings_array, ex_hwvx_proto_collision_settings, g.unordered_ref.hwvx_proto_collision_settings, o + 4, e, 'none');

    g.debug && ex_debug(o, x.sec_id);
    return e
}
function ex_hwvx_proto_triggers_and_actions(o, x) {
    let e = g.triggers_and_actions_offset_hold_data
    su32(o + 0, x.u32_0)
    su32(o + 8, x.u32_8)
    su32(o + 16, x.u32_16)
    su32(o + 28, x.u32_28)
    ...
    g.actions_end_length = x.u32_8 * 4

    switch (x.u32_8) {
    case 1:
        e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_4t1, x.section_4, 'up');
        break;
    case 3:
    ...
    case 6:
        ...
        break;
    default:
        e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_4trest, x.section_4, 'up');
        break;
    }
    ...
    if (x.section_12.length) {
        ...
        g.oa.push(o + 12)
        let temp_offset = e
        e += divisible(x.section_12.length * 44, 16)
        for (let i = 0; i < x.section_12.length; i++) {
            e = ex_hwvx_proto_triggers_and_actions_12(temp_offset + (i * 44), e, x.section_12[i])
        }
        ;
    }
    ;if (x.section_20.length) {
        ...
        g.oa.push(o + 20)
        let temp_offset = e
        e += divisible(x.section_20.length * 24, 16)
        for (let i = 0; i < x.section_20.length; i++) {
            e = ex_hwvx_proto_triggers_and_actions_20(temp_offset + (i * 24), e, x.section_20[i])
        }
        ;
    }
    ;e = ex_s_offset(o + 24, e, ex_hwvx_proto_triggers_and_actions_24, x.section_24, 'up');

    g.debug && ex_debug(o, x.sec_id);
    g.triggers_and_actions_offset_hold_data = e
    return o + 44
}
...
function ex_hwvx_proto_triggers_and_actions_4t5(o, x) {
    ...
    triggers_and_actions_get_link(x.section_4, x.section_4_type, o + 4)
    g.oa.push(o + 4)

    switch (x.u32_16) {
    case 22:
        sf32(o + 12, x.section_12)
        break
    default:
        triggers_and_actions_get_link(x.section_12, x.section_12_type, o + 12)
        g.oa.push(o + 12)
    }

    // let section_type = 
    // let section = x.section_4
    // if (section_type === 'no link ?') {
    //     g.oa.push(o + 4)
    //     su32(o + 4, x.section_4)
    // } else {
    //     g.triggers_and_actions_hold_multilink.push([section, window[`g`][`${section_type}_array`], window[`ex_${section_type}`], window[`g`]['unordered_ref'][section_type], o + 4, e, 'down'])
    // }
...
function triggers_and_actions_get_link(section, type, o, e) {
    if (type === 'no link ?') {
        g.oa.push(o)
        su32(o, section)
    } else {
        g.triggers_and_actions_hold_multilink.push([section, window[`g`][`${type}_array`], window[`ex_${type}`], window[`g`]['unordered_ref'][type], o, 0, 'none'])
    }
...
function ex_hwvx_proto_triggers_and_actions_4t6(o, x) {
    ...
    g.triggers_and_actions_hold_multilink.push([x.unordered_hwvx_proto_world_12_12, g.hwvx_proto_world_12_array, ex_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12, o + 12, e, 'down']);
...
function ex_hwvx_proto_triggers_and_actions_4trest(o, x) {
    let e = o
    let i = 4
    if (x.section_2.length) {
        su32(o + 0, x.section_2.length)
        for (let ii = 0; ii < x.section_2.length; ii++,
        i += 4) {
            ex_hwvx_proto_triggers_and_actions_4trest_section(o + i, x.section_2[ii])
        }
    }
    if (x.section_4.length) {
        su32(o + i, x.section_4.length)
        i += 4
        for (let ii = 0; ii < x.section_4.length; ii++,
        i += 4) {
            ex_hwvx_proto_triggers_and_actions_4trest_section(o + i, x.section_4[ii])
        }
    }
    i += 1
    if (g.actions_end_length < i) {
        i = g.actions_end_length
    }

    g.debug && ex_debug(o, x.sec_id);
    return e + divisible(i, 16)
    // return e + g.actions_end_length
}

function ex_hwvx_proto_triggers_and_actions_4trest_section(o, x) {
    triggers_and_actions_get_link(x.section_0, x.type, o + 0)
    g.oa.push(o + 0)
}
function ex_hwvx_proto_triggers_and_actions_12(o, e, x) {
    su32(o + 0, x.u32_0)
    su32(o + 8, x.u32_8)
...
function ex_hwvx_proto_triggers_and_actions_12_4(o, x) {
    ...
    switch (x.u32_16) {
    case 0:
        g.triggers_and_actions_hold_multilink.push([x.section_12, g.hwvx_proto_world_12_array, ex_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12, o + 12, e, 'down']);
        break;
    default:
        sf32(o + 12, x.section_12)
    }
...
function ex_hwvx_proto_triggers_and_actions_20(o, e, x) {
    su32(o + 0, x.u32_0)
    su32(o + 8, x.u32_8)
    su32(o + 12, x.u32_12)
    su8(o + 16, x.u8_16)
    ...
    case 1:
        switch (x.u32_8) {
        case 12:
            e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_20_4t1t12, x.section_4, 'up');
            break
        case 13:
            e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_20_4t1t13, x.section_4, 'up');
            break
        case 16:
            e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_20_4t1t16, x.section_4, 'up');
            break
        default:
            console.log(o)
        }
        break
    case 2:
        e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_20_4t2, x.section_4, 'up');
        break
    case 3:
        e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_20_4t3, x.section_4, 'up');
        break
    case 4:
        e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_20_4t4, x.section_4, 'up');
        break
    case 5:
    ...
    case 15:
        switch (x.u32_8) {
        case 1:
            e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_20_4t15t1, x.section_4, 'up');
            break
        case 5:
        ...
        break
    case 17:
        e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_20_4t17, x.section_4, 'up');
        break
    case 20:
    ...
    case 21:
        ...
        break
    case 22:
        e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_20_4t22, x.section_4, 'up');
        break
    case 24:
...
function ex_hwvx_proto_triggers_and_actions_20_4t0(o, x) {
    let e = o
    su32(o + 0, x.u32_0)
    let i = 8
    if (x.u32_4) {
...
function ex_hwvx_proto_triggers_and_actions_20_4t0_2(o, x) {
    triggers_and_actions_get_link(x, "hwvx_proto_world_108_44t6", o + 0)
    g.oa.push(o + 0)
}
function ex_hwvx_proto_triggers_and_actions_20_4t1t12(o, x) {
    ...
    case 1:
        if (x.section_8) {
            g.triggers_and_actions_hold_multilink.push([x.section_8, g.hwvx_proto_world_12_array, ex_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12, o + 8, e, 'none']);
            g.oa.push(o + 8)
        }
        break;
    case 6:
        if (x.section_8) {
            g.triggers_and_actions_hold_multilink.push([x.section_8, g.hwvx_proto_world_120_0_array, ex_hwvx_proto_world_120_0, g.unordered_ref.hwvx_proto_world_120_0, o + 8, e, 'down']);
            g.oa.push(o + 8)
        }
        break;
    }
    ...
    case 1:
        if (x.section_28) {
            g.triggers_and_actions_hold_multilink.push([x.section_28, g.hwvx_proto_world_12_array, ex_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12, o + 28, e, 'none']);
            g.oa.push(o + 28)
        }
        break;
    case 2:
        g.triggers_and_actions_hold_multilink.push([x.section_28, g.hwvx_proto_world_36_48_8_array, ex_hwvx_proto_world_36_48_8, g.unordered_ref.hwvx_proto_world_36_48_8, o + 28, e, 'down']);
        break;
    case 6:
        if (x.section_28) {
            g.triggers_and_actions_hold_multilink.push([x.section_28, g.hwvx_proto_world_120_0_array, ex_hwvx_proto_world_120_0, g.unordered_ref.hwvx_proto_world_120_0, o + 28, e, 'down']);
            g.oa.push(o + 28)
        }
        break;
    }
...
function ex_hwvx_proto_triggers_and_actions_20_4t1t13(o, x) {
    let e = o + 64
    su32(o + 0, x.u32_0)
    sf32(o + 4, x.f32_4)
    su32(o + 8, x.u32_8)
    ...
    case 1:
        ...
        break;
    case 2:
        g.triggers_and_actions_hold_multilink.push([x.section_12, g.hwvx_proto_world_36_48_8_array, ex_hwvx_proto_world_36_48_8, g.unordered_ref.hwvx_proto_world_36_48_8, o + 12, e, 'down']);
        break;
    case 6:
        if (x.section_12) {
            g.triggers_and_actions_hold_multilink.push([x.section_12, g.hwvx_proto_world_120_0_array, ex_hwvx_proto_world_120_0, g.unordered_ref.hwvx_proto_world_120_0, o + 12, e, 'none']);
            g.oa.push(o + 12)
        }
        break;
    }
    ...
    case 1:
        if (x.section_32) {
            g.triggers_and_actions_hold_multilink.push([x.section_32, g.hwvx_proto_world_12_array, ex_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12, o + 32, e, 'none']);
            g.oa.push(o + 32)
        }
        break;
    case 2:
        g.triggers_and_actions_hold_multilink.push([x.section_32, g.hwvx_proto_world_36_48_8_array, ex_hwvx_proto_world_36_48_8, g.unordered_ref.hwvx_proto_world_36_48_8, o + 32, e, 'down']);
        break;
    case 6:
        if (x.section_32) {
            g.triggers_and_actions_hold_multilink.push([x.section_32, g.hwvx_proto_world_120_0_array, ex_hwvx_proto_world_120_0, g.unordered_ref.hwvx_proto_world_120_0, o + 32, e, 'down']);
            g.oa.push(o + 32)
        }
        break;
    }
...
function ex_hwvx_proto_triggers_and_actions_20_4t1t16(o, x) {
    ...
    case 1:
        if (x.section_24) {
            g.triggers_and_actions_hold_multilink.push([x.section_24, g.hwvx_proto_world_12_array, ex_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12, o + 24, e, 'none']);
            g.oa.push(o + 24)
        }
        break;
    case 2:
        g.triggers_and_actions_hold_multilink.push([x.section_24, g.hwvx_proto_world_36_48_8_array, ex_hwvx_proto_world_36_48_8, g.unordered_ref.hwvx_proto_world_36_48_8, o + 24, e, 'down']);
        break;
    }
    switch (x.u32_40) {
    case 1:
        if (x.section_44) {
            g.triggers_and_actions_hold_multilink.push([x.section_44, g.hwvx_proto_world_12_array, ex_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12, o + 44, e, 'none']);
            g.oa.push(o + 44)
        }
        break;
    case 2:
        g.triggers_and_actions_hold_multilink.push([x.section_44, g.hwvx_proto_world_36_48_8_array, ex_hwvx_proto_world_36_48_8, g.unordered_ref.hwvx_proto_world_36_48_8, o + 44, e, 'down']);
        break;
    }
    g.debug && ex_debug(o, x.sec_id);
    return e
...
function ex_hwvx_proto_triggers_and_actions_20_4t2(o, x) {
    ...
    if (x.u32_4) {
        ...
        for (let ii = 0; ii < x.section_2.length; ii++,
        i += 4) {
            triggers_and_actions_get_link(x.section_2[ii], "hwvx_proto_world_36_48_8", o + i)
            g.oa.push(o + i)
        }
    }
    i += 1
...
function ex_hwvx_proto_triggers_and_actions_20_4t3(o, x) {
    ...
    if (x.u32_4) {
        ...
        for (let ii = 0; ii < x.section_2.length; ii++,
        i += 4) {
            triggers_and_actions_get_link(x.section_2[ii], "hwvx_proto_world_36_48_16", o + i)
            g.oa.push(o + i)
        }
    }
    i += 1
...
function ex_hwvx_proto_triggers_and_actions_20_4t7(o, x) {
    ...
    triggers_and_actions_get_link(x.section_8, x.type, o + 8)
    g.oa.push(o + 8)
    // g.triggers_and_actions_hold_multilink.push([x.unordered_hwvx_proto_world_76_8,g.hwvx_proto_world_76_array ,ex_hwvx_proto_world_76,g.unordered_ref.hwvx_proto_world_76, o + 8, e, 'down']);
...
function ex_hwvx_proto_triggers_and_actions_20_4t8(o, x) {
    ...
    triggers_and_actions_get_link(x.section_12, x.type, o + 12)
    g.oa.push(o + 12)
...
function ex_hwvx_proto_triggers_and_actions_20_4t9(o, x) {
    ...
    g.triggers_and_actions_hold_multilink.push([x.unordered_hwvx_proto_world_20_20, g.hwvx_proto_world_20_array, ex_hwvx_proto_world_20, g.unordered_ref.hwvx_proto_world_20, o + 20, e, 'down']);
...
function ex_hwvx_proto_triggers_and_actions_20_4t12(o, x) {
    ...
    if (x.u32_4) {
        ...
        for (let ii = 0; ii < x.section_2.length; ii++,
        i += 4) {
            triggers_and_actions_get_link(x.section_2[ii], "hwvx_proto_world_120_0", o + i)
            g.oa.push(o + i)
        }
    }
    i++
...
function ex_hwvx_proto_triggers_and_actions_20_4t15t1(o, x) {
    let e = o + divisible(16, g.divisibility)
    su32(o + 0, x.u32_0)
...
function ex_hwvx_proto_triggers_and_actions_20_4t15t5(o, x) {
    let e = o + divisible(32, g.divisibility)
    su32(o + 0, x.u32_0)
...
function ex_hwvx_proto_triggers_and_actions_20_4t21(o, x) {
    ...
    g.triggers_and_actions_hold_multilink.push([x.unordered_hwvx_proto_world_52_4, g.hwvx_proto_world_52_array, ex_hwvx_proto_world_52, g.unordered_ref.hwvx_proto_world_52, o + 4, e, 'down']);
    g.triggers_and_actions_hold_multilink.push([x.unordered_hwvx_proto_world_12_12, g.hwvx_proto_world_12_array, ex_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12, o + 12, e, 'down']);
...
function ex_hwvx_proto_triggers_and_actions_20_4t24(o, x) {
    ...
    g.triggers_and_actions_hold_multilink.push([x.unordered_hwvx_proto_triggers_and_actions_20_4t24t5_4_4, g.hwvx_proto_world_36_48_24_array, ex_hwvx_proto_world_36_48_24, g.unordered_ref.hwvx_proto_world_36_48_24, o + 4, e, 'down']);
    g.triggers_and_actions_hold_multilink.push([x.unordered_hwvx_proto_triggers_and_actions_20_4t24t5_12_12, g.hwvx_proto_world_12_array, ex_hwvx_proto_world_12, g.unordered_ref.hwvx_proto_world_12, o + 12, e, 'down']);
...
function ex_hwvx_proto_triggers_and_actions_20_4t31(o, x) {
    ...
    g.triggers_and_actions_hold_multilink.push([x.unordered_hwvx_proto_interface_4, g.hwvx_proto_interface_array, ex_hwvx_proto_interface, g.unordered_ref.hwvx_proto_interface, o + 4, e, 'down']);
...
function ex_hwvx_proto_triggers_and_actions_24(o, x) {
    ...
    e = ex_s_offset(o + 4, e, ex_hwvx_proto_triggers_and_actions_24_4, x.section_4, 'down');
...
function ex_hwvx_proto_models(o, x) {
    ...
    g.hwvx_proto_model_12_offset_hold = 0
    // g.hwvx_proto_model_string_offset_hold = 0
    if (x.section_8.length) {
        su16(o + 2, x.section_8.length)
        su32(o + 8, e - g.m)
        g.oa.push(o + 8)
        if (x.section_12.length) {
            g.oa.push(o + 12)
        ...
        g.hwvx_proto_model_12_offset_hold = e
        e += divisible(x.section_12.length * 4, 16)
        for (let i = 0; i < x.section_8.length; i++) {
    ...
    ;if (x.section_12.length) {
        ...
        su32(o + 12, g.hwvx_proto_model_12_offset_hold)
        let temp_offset = g.hwvx_proto_model_12_offset_hold
        // e += divisible(x.section_12.length * 4, 16)
        for (let i = 0; i < x.section_12.length; i++) {
...
function ex_hwvx_proto_model_8_8(o, e, x) {
    ...
    su32(o + 24, x.temp_texture_value)
    // }
    ...
    switch (globalThis.modeltypeval) {
    case 0:
...
function ex_hwvx_proto_model_8_8_12_modeldata(o, x) {
    let buffer = convert_base64_arraybuffer(x[0].temp_buffer)
    new Uint8Array(dynamic_buffer).set(new Uint8Array(buffer), o)

    return o + buffer.byteLength
}
function ex_hwvx_proto_texture_anims(o, x) {
    // let e = 0
    // later
...
function ex_hwvx_proto_model_anims_1(o, x) {
    ...
    if (x.section_44_temp === true) {
        su32(o + 44, e - g.m)
        g.oa.push(o + 44)
        // same as previous value
    }
    e = ex_s_offset(o + 44, e, ex_hwvx_proto_model_anims_1_44, x.section_44, 'down');
...
//     return e
// }
function ex_hwvx_proto_model_anims_1_44(o, x) {
    let buffer = convert_base64_arraybuffer(x.temp_buffer)
    new Uint8Array(dynamic_buffer).set(new Uint8Array(buffer), o)
...
function ex_hwvx_proto_world_text_link(o, x) {
    ...
    e = ex_ml(x.unordered_hwvx_proto_world_small_section_12, g.hwvx_proto_world_small_section_array, ex_hwvx_proto_world_small_section, g.unordered_ref.hwvx_proto_world_small_section, o + 12, e, 'down');
    e = ex_ml(x.unordered_hwvx_proto_world_small_section_16, g.hwvx_proto_world_small_section_array, ex_hwvx_proto_world_small_section, g.unordered_ref.hwvx_proto_world_small_section, o + 16, e, 'down');
    e = ex_ml(x.unordered_hwvx_proto_text_20, g.hwvx_proto_text_array, ex_hwvx_proto_text, g.unordered_ref.hwvx_proto_text, o + 20, e, 'down');
    e = ex_ml(x.unordered_hwvx_proto_text_24, g.hwvx_proto_text_array, ex_hwvx_proto_text, g.unordered_ref.hwvx_proto_text, o + 24, e, 'down');
...
function ex_hwvx_proto_world_settings(o, x) {
    let e = o + divisible(304, g.divisibility)
    sf32(o + 4, x.f32_4)
    sf32(o + 8, x.f32_8)
    sf32(o + 12, x.f32_12)
    sf32(o + 16, x.f32_16)
    ...
    ex_patch(o + 144, g.texture_patch_array, x.texture_144)//amount?   su32(o +232, x.u32_232)
    ...
    if (x.u32_156_is_offset) {
        let section = x.section_156_type
        if (x.section_156_type === 'no link ?') {
            g.oa.push(o + 156)
            su32(o + 156, x.u32_156)
        } else {
            e = ex_ml(x.section_156, window[`g`][`${section}_array`], window[`ex_${section}`], window[`g`]['unordered_ref'][section], o + 156, e, 'down');
        }
    }
...
function ex_hwvx_proto_world_model_related(o, x) {
    ...
    switch (x.u8_4) {
    case 0:
        e = ex_ml(x.section_0, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.ordered_ref.hwvx_proto_models, o + 0, e, 'none', true, "model");
        break;
    case 1:
    ...
    if (x.section_28.length) {
        ...
        e += divisible(x.section_28.length * 32, 16)
        for (let i = 0; i < x.section_28.length; i++) {
            e = ex_hwvx_proto_mysterious(temp_offset + (i * 32), e, x.section_28[i])
        }
        ;
    }
    ;g.debug && ex_debug(o, x.sec_id);
...
function ex_hwvx_proto_car(o, x) {
    ...
    e = ex_ml(x.model_84, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.ordered_ref.hwvx_proto_models, o + 84, e, 'none', true, "model");
    ...
    ;e = ex_s_offset(o + 252, e, ex_hwvx_proto_car_252, x.section_252, 'up');
    ...
    e = ex_s_offset(o + 260, e, ex_hwvx_proto_car_260, x.section_260, 'up');
...
function ex_hwvx_proto_car_228(o, e, x) {
    ...
    if (x.section_8.length) {
        ...
        e += divisible(x.section_8.length * 32, 16)
        for (let i = 0; i < x.section_8.length; i++) {
            e = ex_hwvx_proto_mysterious(temp_offset + (i * 32), e, x.section_8[i])
        }
        ;
    }
    ;g.debug && ex_debug(o, x.sec_id);
...
function ex_hwvx_proto_car_link(o, x) {
    ...
    e = ex_ml(x.unordered_hwvx_proto_car_sub_link_48, g.hwvx_proto_car_sub_link_array, ex_hwvx_proto_car_sub_link, g.unordered_ref.hwvx_proto_car_sub_link, o + 48, e, 'down');
    ...
    ;e = ex_s_offset(o + 64, e, ex_hwvx_proto_car_link_64, x.section_64, 'up');

    g.debug && ex_debug(o, x.sec_id);
    return e
}
function ex_hwvx_proto_car_sub_link(o, x) {
    let e = o + divisible(96, g.divisibility)
    sf32(o + 4, x.f32_4)
    sf32(o + 8, x.f32_8)
    sf32(o + 12, x.f32_12)
...
function ex_hwvx_proto_mysterious_24t5(o, x) {
    let e = o + divisible(48, g.divisibility)
    e = ex_ml(x.model_8, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.ordered_ref.hwvx_proto_models, o + 8, e, 'none', true, "model");
    su32(o + 8, x.model_8_temp)// ex_patch(o + 8, g.hwvx_proto_model_array, x.model_8)
    //amount?   su32(o +20, x.u32_20)
...
function ex_hwvx_proto_mysterious_24t9_32(o, x) {
    let e = o + divisible(4, g.divisibility)
    su8(o + 1, x.u8_1)
    su8(o + 2, x.u8_2)
    su8(o + 3, x.u8_3)
...
function ex_hwvx_proto_model_link(o, x) {
    ...
    if (x.section_12.length) {
        ...
        for (let i = 0; i < x.section_12.length; i++) {
            e = ex_hwvx_proto_model_link_12(temp_offset + (i * 8), e, x.section_12[i])
        }
        ;
    }
    ...
    if (x.section_48.length) {
        ...
        e += divisible(x.section_48.length * 32, 16)
        for (let i = 0; i < x.section_48.length; i++) {
            e = ex_hwvx_proto_mysterious(temp_offset + (i * 32), e, x.section_48[i])
        }
        ;
    }
...
function ex_hwvx_proto_model_link_12(o, e, x) {
    e = ex_ml(x.model_0, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.ordered_ref.hwvx_proto_models, o + 0, e, 'none', true, "model");
    su32(o + 4, x.u32_4)
...
function ex_hwvx_proto_model_link_56(o, x) {
    let e = o + divisible(16, g.divisibility)//amount?   su32(o +0, x.u32_0)
...
function ex_hwvx_proto_model_link_56_4(o, e, x) {
    ...
    su8(o + 2, x.u8_2)
    su32(o + 4, x.u32_4)
    // ex_patch(o + 8, g.hwvx_proto_model_array, x.model_8)
    e = ex_ml(x.model_8, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.ordered_ref.hwvx_proto_models, o + 8, e, 'none', true, "model");
...
function ex_hwvx_proto_interface(o, x) {
    ...
    su32(o + 0, x.u32_0)
    su32(o + 4, x.u32_4)
    su32(o + 8, x.u32_8)//amount?   su32(o +12, x.u32_12)
    //amount?   su32(o +20, x.u32_20)
...
function ex_hwvx_proto_interface_16(o, e, x) {
    ...
    case 2:
        ...
        break;
    case 4:
        e = ex_s_offset(o + 20, e, ex_hwvx_proto_interface_16_20t4, x.section_20, 'down');
        break;
    case 10:
        e = ex_s_offset(o + 20, e, ex_hwvx_proto_interface_16_20t10, x.section_20, 'down');
        break;
    case 11:
        e = ex_s_offset(o + 20, e, ex_hwvx_proto_interface_16_20t11, x.section_20, 'down');
        break;
    }
...
function ex_hwvx_proto_interface_16_20t0(o, x) {
    ...
    switch (x.u8_0) {
    case 0:
        ex_patch(o + 4, g.texture_patch_array, x.section_4)
        break;
    case 1:
        e = ex_ml(x.section_4, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.ordered_ref.hwvx_proto_models, o + 4, e, 'none', true, "model");
        su32(o + 4, x.section_4_temp)
        break;
    case 3:
...
function ex_hwvx_proto_interface_16_68(o, x) {
    ...
    if (x.section_20.length) {
        ...
        for (let i = 0; i < x.section_20.length; i++) {
            e = ex_hwvx_proto_interface_16_68_20(temp_offset + (i * 12), e, x.section_20[i])
        }
        ;
    }
    ;g.debug && ex_debug(o, x.sec_id);
...
function ex_hwvx_proto_interface_16_68_20(o, e, x) {
    su32(o + 0, x.u32_0)
    su32(o + 4, x.u32_4)
...
function ex_hwvx_proto_interface_16_104_8(o, x) {
    let e = o + divisible(60, g.divisibility)
    //amount?   su32(o +0, x.u32_0)
    //amount?   su32(o +8, x.u32_8)
    //amount?   su32(o +16, x.u32_16)
    //amount?   su32(o +24, x.u32_24)
    ...
    ;e = ex_s_offset(o + 56, e, ex_hwvx_proto_interface_16_104_8_56, x.section_56, 'up');
...
function ex_hwvx_proto_interface_text_related(o, x) {
    ...
    ;if (x.section_48.length) {
        ...
        for (let i = 0; i < x.section_48.length; i++) {
            e = ex_hwvx_proto_interface_text_related_20(temp_offset + (i * 16), e, x.section_48[i])
        }
        ;
    }
...
function ex_hwvx_proto_unknown_4(o, e, x) {
    ...
    case 26:
        ...
        break;
    case 29:
        e = ex_ml(x.section_4, g.hwvx_proto_unknown_small_model_link_array, ex_hwvx_proto_unknown_small_model_link, g.unordered_ref.hwvx_proto_unknown_small_model_link, o + 4, e, 'down');
        break;
    default:
        su32(o + 4, x.section_4)
        break
...
function ex_hwvx_proto_unknown_4_4t8(o, x) {
    ...
    if (x.section_24.length) {
        ...
        e += divisible(x.section_24.length * 12, 16)
        for (let i = 0; i < x.section_24.length; i++) {
            e = ex_hwvx_proto_unknown_4_4t8_24(temp_offset + (i * 12), e, x.section_24[i])
        }
        ;
    }
...
function ex_hwvx_proto_unknown_4_4t8_24(o, e, x) {
    // let e = o + divisible(12, g.divisibility)
    su8(o + 0, x.u8_0)
    su8(o + 1, x.u8_1)
    su8(o + 2, x.u8_2)
...
function ex_hwvx_proto_unknown_small_model_link(o, x) {
    let e = o + divisible(16, g.divisibility)
    su32(o + 0, x.u32_0)
    su32(o + 4, x.u32_4)
    //amount?   su32(o +8, x.u32_8)
    ...
    if (x.section_12.length) {
        ...
        for (let i = 0; i < x.section_12.length; i++) {
            e = ex_hwvx_proto_unknown_small_model_link_12(temp_offset + (i * 48), e, x.section_12[i])
        }
        ;
    }
    ;g.debug && ex_debug(o, x.sec_id);
...
function ex_hwvx_proto_unknown_small_model_link_12(o, e, x) {
    sf32(o + 0, x.f32_0)
    sf32(o + 4, x.f32_4)
    sf32(o + 8, x.f32_8)
    sf32(o + 16, x.f32_16)
    sf32(o + 20, x.f32_20)
    sf32(o + 24, x.f32_24)
    // ex_patch(o + 28, g.hwvx_proto_model_array, x.model_28)
    e = ex_ml(x.model_28, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.ordered_ref.hwvx_proto_models, o + 28, e, 'none', true, "model");
    su32(o + 28, x.model_28_temp)
...
function ex_hwvx_proto_unknown_thing_4t2(o, x) {
    ...
    su32(o + 0, x.u32_0)
    sf32(o + 4, x.f32_4)
    sf32(o + 8, x.f32_8)//amount?   su32(o +12, x.u32_12)
    //amount?   su32(o +20, x.u32_20)
...
function ex_hwvx_proto_asdf(o, x) {
    ...
    su8(o + 7, x.u8_7)
    su32(o + 8, x.u32_8)
    e = ex_ml(x.model_16, g.hwvx_proto_model_array, ex_hwvx_proto_models, g.ordered_ref.hwvx_proto_models, o + 16, e, 'none', true, "model");
    su32(o + 16, x.model_16_temp)
    ...
    ;if (x.section_160.length) {
        ...
        g.oa.push(o + 160)
        let temp_offset = e
        e += divisible(x.section_160.length * 32, 16)
        for (let i = 0; i < x.section_160.length; i++) {
            e = ex_hwvx_proto_mysterious(temp_offset + (i * 32), e, x.section_160[i])
        }
        ;
    }
...
function ex_hwvx_proto_item(o, x) {
    ...
    if (x.section_60.length) {
        ...
        g.oa.push(o + 60)
        let temp_offset = e
        e += divisible(x.section_60.length * 32, 16)
        for (let i = 0; i < x.section_60.length; i++) {
            e = ex_hwvx_proto_mysterious(temp_offset + (i * 32), e, x.section_60[i])
        }
        ;
    }
    ;g.debug && ex_debug(o, x.sec_id);
...
function ex_hwvx_proto_item_48_0(o, x) {
    ...
    //amount?   su32(o +8, x.u32_8)
    sf32(o + 24, x.f32_24)
    su32(o + 28, x.u32_28)//amount?   su32(o +44, x.u32_44)
...
function ex_hwvx_proto_sound_section(o, x) {
    ...
    if (x.section_32.length) {
        ...
        e += divisible(x.section_32.length * 12, 16)
        for (let i = 0; i < x.section_32.length; i++) {
            e = ex_hwvx_proto_sound_section_32(temp_offset + (i * 12), e, x.section_32[i])
        }
        ;
    }
    ;g.debug && ex_debug(o, x.sec_id);
...
function ex_hwvx_proto_sound_section_32(o, e, x) {
    sf32(o + 0, x.f32_0)
    su8(o + 5, x.u8_5)
    sf32(o + 8, x.f32_8)
...
function ex_hwvx_proto_texture_anims_0(o, x) {
    ...
    g.hwvx_proto_texture_anims_old_offsets.shift()//amount?   su32(o +4, x.u32_4)
    //amount?   su32(o +12, x.u32_12)
    ;
