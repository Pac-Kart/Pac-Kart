...
function im_hwvx_proto_datapack(o, i, x) {
    ...
    x[0].hwvx_proto_audio_index_patch_padding = offset_index_patch - padding_test
...
u32(o + 16) ? im_hwvx_proto_world_36_48_16(u32(o + 16) + g.m,x[i].section_16) : 0; // offset? 
...
x.push({
 ...
 u32(o + 0) ? im_hwvx_proto_collision_settings(u32(o + 0) + g.m,x[i].section_0) : 0; // offset? 
u32(o + 4) ? im_hwvx_proto_collision_settings(u32(o + 4) + g.m,x[i].section_4) : 0; // offset? 
return x[i].id 
// 16 bytes;
...
//     im_hwvx_proto_model_8_8_12_modeldata(u32(o + 54) + (i * 16) + g.m, i, x[0].section_54);
// }
...
x.push({
 ...
 u32(o + 0) ? im_hwvx_proto_texture_anims_0(u32(o + 0) + g.m,x[i].section_0) : 0; // offset? 
return x[i].id 
// 12 bytes;
...
x.push({
 ...
 u32(o + 12) ? im_hwvx_proto_world_small_section(u32(o + 12) + g.m,x[i].section_12) : 0; // offset? 
u32(o + 16) ? im_hwvx_proto_world_small_section(u32(o + 16) + g.m,x[i].section_16) : 0; // offset? 
u32(o + 20) ? im_hwvx_proto_text(u32(o + 20) + g.m,x[i].section_20) : 0; // offset? 
u32(o + 24) ? im_hwvx_proto_text(u32(o + 24) + g.m,x[i].section_24) : 0; // offset? 
return x[i].id 
// 32 bytes;
...
x[i].section_0 = in_ml(u32(o + 0), g.hwvx_proto_model_link_array, im_hwvx_proto_model_link, g.unordered_ref.hwvx_proto_model_link);
    break;
}u32(o + 12) ? im_hwvx_proto_sound_controls(u32(o + 12) + g.m,x[i].section_12) : 0; // offset? 
u32(o + 16) ? im_hwvx_proto_car_link(u32(o + 16) + g.m,x[i].section_16) : 0; // offset? 
u32(o + 20) ? im_hwvx_proto_model_anims_2(u32(o + 20) + g.m,x[i].section_20) : 0; // offset? 
u32(o + 28) ? im_hwvx_proto_mysterious(u32(o + 28) + g.m,x[i].section_28) : 0; // offset? 
return x[i].id 
// 32 bytes;
...
for (let ii = 0; ii < u32(o + 4); ii++) {
    im_hwvx_proto_mysterious(u32(o + 8) + (ii * 64) + g.m, ii, x[i].section_8);
}
...
for (let ii = 0; ii < u32(o + 44); ii++) {
    im_hwvx_proto_mysterious(u32(o + 48) + (ii * 64) + g.m, ii, x[i].section_48);
}
...
for (let ii = 0; ii < u32(o + 156); ii++) {
    im_hwvx_proto_mysterious(u32(o + 160) + (ii * 64) + g.m, ii, x[i].section_160);
}
...
for (let ii = 0; ii < u32(o + 56); ii++) {
    im_hwvx_proto_mysterious(u32(o + 60) + (ii * 64) + g.m, ii, x[i].section_60);
}
return x[i].id 
// 64 bytes;
...
for (let i = 0; i < u32(o + 44); i++) {
    im_hwvx_proto_mysterious(u32(o + 48) + (i * 64) + g.m, i, x[0].section_48);
}
...
//amount?   su32(o +24, x.u32_24)
 ...
 switch(x.u8_4){
    ...
    break;
}e = ex_s_offset(o + 12, e, ex_hwvx_proto_sound_controls,x.section_12, 'down');
e = ex_s_offset(o + 16, e, ex_hwvx_proto_car_link,x.section_16, 'down');
e = ex_s_offset(o + 20, e, ex_hwvx_proto_model_anims_2,x.section_20, 'down');
e = ex_s_offset(o + 28, e, ex_hwvx_proto_mysterious,x.section_28, 'down');
...
e = ex_s_offset(o + 172, e, ex_hwvx_proto_car_172,x.section_172, 'down');
    ...
    if(x.section_244.length){
        su32(o + ___$$$___,x.section_244.length)
        su32(o + 244, e - g.m)
        g.oa.push(o + 244)
        let temp_offset = e 
...
//amount?   su32(o +136, x.u32_136)
    ...
    if(x.section_140.length){
        su32(o + ___$$$___,x.section_140.length)
        su32(o + 140, e - g.m)
        g.oa.push(o + 140)
        let temp_offset = e 
...
//amount?   su32(o +76, x.u32_76)
    ...
    e = ex_ml(x.unordered_hwvx_proto_unknown_64,g.hwvx_proto_unknown_array ,ex_hwvx_proto_unknown,g.unordered_ref.hwvx_proto_unknown, o + 64, e, 'down');
    if(x.section_72.length){
        su32(o + ___$$$___,x.section_72.length)
        su32(o + 72, e - g.m)
        g.oa.push(o + 72)
        let temp_offset = e 
        e += divisible(x.section_72.length * 4, 16) 
    ...
    if(x.section_80.length){
        su32(o + ___$$$___,x.section_80.length)
        su32(o + 80, e - g.m)
        g.oa.push(o + 80)
        let temp_offset = e 
        e += divisible(x.section_80.length * 4, 16) 
